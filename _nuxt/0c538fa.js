(window.webpackJsonp = window.webpackJsonp || []).push([
    [68], {
        565: function(e, t, r) {
            ...
            (0, r(30).default)("7da00394", content, !0, {
                sourceMap: !1
            })
        },
        810: function(e, t, r) {
        ...
        905: function(e, t, r) {
            ...
            var component = Object(l.a)(n, (function() {
                ...
                return r("BaseSpacing", {
                    ...
                    class: e.$style.socialSlider
                }, [r("BaseContainer", [r("div", {
                    class: e.$style.headerPartition
                }, [r("div", {
                    class: e.$style.headerPartitionLeft
                }, [e.preHeader ? r("p", {
                    class: e.$style.preHeader
                }, [e._v(e._s(e.preHeader))]) : e._e(), e.header ? r("h2", {
                    class: e.$style.header
                }, [e._v(e._s(e.header))]) : e._e()]), e.$prismic.hasUrl(e.instaLink) ? r("BaseLink", {
                    class: e.$style.button,
                    attrs: {
                        "aria-label": e.iconText || "instagram",
                        smart: e.instaLink.url,
                        target: e.instaLink.target,
                        "data-tracking-id": "social-component-" + e.nType + "-instagram-link"
                    }
                }, [r("div", {
                    ...
                    class: e.$style.iconText
                }, [e._v(e._s(e.iconText))]) : e._e()]) : e._e()], 1)]), e.items && e.items.length > 0 ? r("BaseContainer", {
                    attrs: {
                        "no-padding": ""
                    }
                }, [r("div", {
                        ...
                        fn: function(t) {
                            ...
                            return [r("div", {
                                ...
                                attrs: {
                                    ...
                                    image: n.image,
                                    sizes: {
                                        all: "calc(100vw - 19.6rem)",
                                        small: "calc((100vw + 8rem) / 3)",
                                        medium: "calc((100vw + 17rem) / 3)",
                                        large: "calc((100vw + 17rem) / 5)",
                                        xlarge: "32.2rem"
                                    },
                                    critical: e.n < 2
                                }
