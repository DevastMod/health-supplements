(function() {
    ...
    */
    ...
    function Ba(a) {
        ...
        (b = a.l = a.l || b) ? b.eb ? a.i = a.o || a.u : void 0 != b.B && a.u < b.B ? (a.i = b.B, a.l = null) : a.i = a.u: a.i = 0
    }
    ...
    function Ea(a, b, c, d) {
        try {
            ...
            return a.i.m = null, ua(a.i, g), Fa(a)
        }
        a.i.m = null;
        d.call(a.i, f);
        return Fa(a)
    ...
    function Ga(a) {
        this.next = function(b) {
            sa(a.i);
            a.i.m ? b = Ea(a, a.i.m.next, b, a.i.D) : (a.i.D(b), b = Fa(a));
            return b
        };
        this.throw = function(b) {
            sa(a.i);
            a.i.m ? b = Ea(a, a.i.m["throw"], b, a.i.D) : (ua(a.i, b), b = Fa(a));
            return b
        };
    ...
    r("Promise", function(a) {
        ...
        b.prototype.Ha = function(g) {
            ...
            else if (g instanceof b) this.nb(g);
            else {
                a: switch (typeof g) {
                    case "object":
                        var h = null != g;
        ...
        b.prototype.Ga = function(g) {
            ...
            "function" == typeof h ? this.ob(h, g) : this.o(g)
        };
        ...
        var f = new c;
        b.prototype.nb = function(g) {
            var h = this.m();
            g.ya(h.resolve, h.reject)
        };
        b.prototype.ob = function(g, h) {
            var k = this.m();
            try {
        ...
        b.race = function(g) {
            return new b(function(h, k) {
                for (var l = u(g), m = l.next(); !m.done; m = l.next()) d(m.value).ya(h, k)
            })
        };
        b.all = function(g) {
            var h = u(g),
            ...
            return k.done ? d([]) : new b(function(l, m) {
                ...
                var t = [],
                    q = 0;
                do t.push(void 0), q++, d(k.value).ya(p(t.length - 1), m), k = h.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    !F("Android") || Lb();
    Lb();
    var tc = F("Safari") && !(Lb() || F("Coast") || F("Opera") || F("Edge") || F("Edg/") || F("OPR") || F("Firefox") || F("FxiOS") || F("Silk") || F("Android")) && !(ac() || F("iPad") || F("iPod"));
    var uc = {},
        vc = null;
    ...
    Fc.prototype.sizeBytes = function() {
        Ec();
        var a = this.ra;
        null == a || Bc(a) || ("string" === typeof a ? a = yc(a) : (Na(a), a = null));
        return (a = null == a ? a : this.ra = a) ? a.length : 0
    };
    var Gc = "function" === typeof Symbol && "symbol" === typeof Symbol() ? Symbol(void 0) : void 0;

    function Hc(a, b) {
        Object.isFrozen(a) || (Gc ? a[Gc] |= b : void 0 !== a.N ? a.N |= b : Object.defineProperties(a, {
            N: {
                value: b,
                configurable: !0,
                writable: !0,
    ...
    function Lc(a, b) {
        Object.isExtensible(a) && (Gc ? a[Gc] && (a[Gc] &= ~b) : void 0 !== a.N && (a.N &= ~b))
    }
    ...
    function Nc(a, b) {
        Gc ? a[Gc] = b : void 0 !== a.N ? a.N = b : Object.defineProperties(a, {
            N: {
                value: b,
                configurable: !0,
                writable: !0,
    ...
    function $c(a) {
        if (H(a.s)) throw Error("Cannot mutate an immutable Message");
    };
        ...
        switch (typeof a) {
            ...
            case "object":
                if (a && !Array.isArray(a)) {
                    ...
                    if (a instanceof Fc) {
                        var b = a.ra;
                        return null == b ? "" : "string" === typeof b ? b : a.ra = wc(b)
                    }
                }
        }
        return a
    ...
    function id(a, b, c) {
        return -1 === b ? null : b >= a.X ? a.G ? a.G[b] : void 0 : (void 0 === c ? 0 : c) && a.G && (c = a.G[b], null != c) ? c : a.s[b + a.T]
    }
    ...
    function I(a, b, c, d, e) {
        ...
        (void 0 === e ? 0 : e) || $c(a);
        a.cb && (a.cb = void 0);
        if (b >= a.X || d) return (a.G || (a.G = a.s[a.X + a.T] = {}))[b] = c, a;
        void 0 !== a.G && a.X >= a.s.length ? (d = a.s.length - 1, e = b + a.T, e >= d ? (a.s[d] = void 0, a.s[e] = c, a.s.push(a.G)) : a.s[e] = c) : a.s[b + a.T] = c;
    ...
    function jd(a, b, c, d) {
        ...
        var f = Mc(e);
        f & 1 || Oc(e);
        H(a.s) ? (f & 2 || Hc(e, 2), c & 1 || Object.freeze(e)) : e === Zc || !(c & 1 && c & 2) && f & 2 ? (e = Oc(Array.prototype.slice.call(e)), I(a, b, e, d)) : !(c & 2) && f & 16 && Rc(e);
        return e
    }

    function kd(a, b, c, d) {
        $c(a);
        (c = ld(a, c)) && c !== b && null != d && I(a, c, void 0, !1);
        return I(a, b, d)
    }
    ...
    function ld(a, b) {
        for (var c = 0, d = 0; d < b.length; d++) {
            var e = b[d];
            null != id(a, e) && (0 !== c && I(a, c, void 0, !1, !0), c = e)
        }
        return c
    }
    ...
    function md(a, b, c) {
        ...
        var e = id(a, c, d);
        var f = !1;
        var g = null == e || "object" !== typeof e || (f = Array.isArray(e)) || e.Oa !== Tc ? f ? new b(e) : void 0 : e;
        g !== e && null != g && (I(a, c, g, d, !0), Hc(g.s, Mc(a.s) & -33));
        b = g;
        if (null == b) return b;
        H(b.s) && !H(a.s) && (b = nd(b), I(a, c, b, d));
        return b
    }
    ...
    function od(a, b, c, d, e) {
        ...
        var f = a.i[c],
            ...
            l = H(g),
            m = h || l;
        !e && l && (g = Oc(Array.prototype.slice.call(g)), I(a, c, g, d));
        if (!f) {
            f = [];
            d = m;
            for (l = 0; l < g.length; l++) {
                ...
                void 0 !== p && (f.push(p), m && Hc(p.s, 2))
            }
            a.i[c] = f;
            b = g;
            g = !d;
            Object.isFrozen(b) || (k = Mc(b) | 33, Nc(b, g ? k | 8 : k & -9))
        }
        e = h || e;
        h = H(f);
        e && !h && (Object.isFrozen(f) && (a.i[c] = f = f.slice()),
            Hc(f, 2), Object.freeze(f));
        !e && h && (a.i[c] = f = f.slice());
        return f
    }
    ...
    function qd(a, b, c, d) {
        ...
        if (null != d) {
            var e = Oc([]);
            for (var f = !1, g = 0; g < d.length; g++) e[g] = bd(d[g], b).s, f = f || H(e[g]);
            a.i || (a.i = {});
            a.i[c] = d;
            b = e;
            f ? Lc(b, 8) : Hc(b, 8)
        } else a.i && (a.i[c] = void 0), e = Zc;
        return I(a, c, e)
    }
    ...
    function ud(a, b, c, d, e, f) {
        (a = a.i && a.i[c]) ? (e = f.Ka ? Oc(a.slice()) : a, qd(b, 0 < e.length ? e[0].constructor : void 0, c, e)) : (null != d ? Ac && d instanceof Uint8Array ? e = d.length ? new Fc(new Uint8Array(d)) : Dc || (Dc = new Fc(null)) : (Array.isArray(d) && (e ? Hc(d, 2) : d && Mc(d) & 1 && f.Ka ? (e = Array.prototype.slice.call(d), Nc(e, (Mc(d) | 0) & -51), d = e) : Rc(d)), e = d) : e = void 0, I(b, c, e))
    };
    ...
    function L(a, b, c) {
        ...
        var d = this.constructor.i || 0,
            ...
            g, h = !1;
        if (a) {
            if (g = !!(Mc(a) & 16)) h = Mc(a), Nc(a, h | 32), h = !!(h & 32)
        } else g = f ? [f] : [], Hc(g, 48), a = g, g = !0;
        ...
        a: {
            ...
            if (f && (f = this.s[d], Uc(f))) {
                this.G = f;
                b = Object.keys(f);
                0 < b.length && db(b, isNaN) ? this.X = Number.MAX_VALUE : this.X = d - this.T;
                break a
            }
            void 0 !== b && -1 < b ? (this.X = Math.max(b, d + 1 - this.T), this.G = void 0) : this.X = Number.MAX_VALUE
        }
        if (!e && this.G && "g" in this.G) throw Error('Unexpected "g" flag in sparse object of message that is not a group type.');
        if (c)
            for (e = g && !h ? Pc : Oc, b = 0; b < c.length; b++) g = c[b], (h = id(this, g)) ? Array.isArray(h) && e(h) : I(this, g, Zc, !1, !0)
    }
    n = L.prototype;
    n.toJSON = function() {
        var a = this.s,
    ...
    function nd(a) {
        if (H(a.s)) {
            var b = {
                ...
                c = H(a.s);
            if (c && !b.Ka) throw Error("copyRepeatedFields must be true for frozen messages");
            c || Rc(a.s);
            var d = new a.constructor;
            a.la && (d.la = a.la.slice());
            for (var e = a.s, f = 0; f < e.length; f++) {
                var g = e[f];
                if (f === e.length - 1 && Uc(g))
                    for (var h in g) {
                        var k = +h;
                        Number.isNaN(k) ? (d.G || (d.G = d.s[d.X + d.T] = {}))[h] = g[h] : ud(a, d, k, g[h], c, b)
                    } else ud(a, d, f - a.T, g, c, b)
            }
            d.cb = a;
            a = d
        }
                ...
                if (e) {
                    ...
                    if (Array.isArray(e)) {
                        if (e.length) {
                            ...
                            if (h) {
                                for (h = 0; h < f.length; h++)(l = f[h]) && H(l.s) && (f[h] = nd(f[h]), g[h] = f[h].s);
                                Hc(g, 8)
                            }
                            for (g = 0; g < Math.min(f.length, e.length); g++) yd(f[g], e[g])
                        }
        ...
        if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
            ...
            if (null ==
                ...
                if (a.constructor && a.constructor instanceof Function) {
                    ...
                    else if (c = a.constructor, Cd[c]) c = Cd[c];
                    else {
                        c = String(c);
                        if (!Cd[c]) {
                            var f = /function\s+([^\(]+)/m.exec(c);
                            Cd[c] = f ? f[1] : "[Anonymous]"
                        }
                        c = Cd[c]
                    }
    ...
    */
    ...
    function Gd(a, b) {
        ...
        if (b instanceof Hb) b instanceof Hb && b.constructor === Hb ? b = b.i : (Na(b), b = "type_error:SafeUrl");
        else {
            b: if (Fd) {
                try {
                    var c = new URL(b)
    ...
    function Wd(a, b) {
        ...
        for (var c = 0; c < b.length; ++c) {
            var d = b[c];
            if (d instanceof Td && d.isValid(a)) return new Hb(a, Ib)
        }
    }
    ...
    var $d = "client_dev_domain client_dev_regex_map client_dev_root_url client_rollout_override expflag forcedCapability jsfeat jsmode mods".split(" ");
    ia($d);
    ...
    function ae() {
            ...
            for (q = 0; 80 > q; q++) {
                if (40 > q)
                    if (20 > q) {
                        var M = G ^ w & (z ^ G);
                        var O = 1518500249
                    } else M = w ^ z ^ G, O = 1859775393;
                else 60 > q ? (M = w & z | G & (w | z), O = 2400959708) : (M = w ^ z ^ G, O = 3395469782);
        ...
        function c(p, t) {
            if ("string" === typeof p) {
                ...
                for (var q = [], w = 0, z = p.length; w < z; ++w) q.push(p.charCodeAt(w));
                p = q
            }
            t || (t = p.length);
            q = 0;
    ...
    function be(a, b, c) {
        ...
        return d && a && b ? [b, ce(Zd(d), a, c || null)].join(" ") : null
    }
    ...
    var ge = new fe("undefined" == typeof document ? null : document);

    function he(a) {
        return !!ee.FPA_SAMESITE_PHASE2_MOD || !(void 0 === a || !a)
    }

    function ie(a, b, c, d) {
        (a = A[a]) || (a = (new fe(document)).get(b));
        return a ? be(a, c, d) : null
    }

    function je(a) {
        var b = void 0 === b ? !1 : b;
        var c = Zd(String(A.location.href)),
            d = [];
        var e = b;
        e = void 0 === e ? !1 : e;
        var f = A.__SAPISID || A.__APISID || A.__3PSAPISID || A.__OVERRIDE_SID;
        he(e) && (f = f || A.__1PSAPISID);
        if (f) e = !0;
        else {
            var g = new fe(document);
            f = g.get("SAPISID") || g.get("APISID") || g.get("__Secure-3PAPISID") || g.get("SID");
            he(e) && (f = f || g.get("__Secure-1PAPISID"));
            e = !!f
        }
        e && (e = (c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:")) ? A.__SAPISID : A.__APISID, e || (e = new fe(document),
            e = e.get(c ? "SAPISID" : "APISID") || e.get("__Secure-3PAPISID")), (e = e ? be(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e), c && he(b) && ((b = ie("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && d.push(b), (a = ie("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && d.push(a)));
    ...
    ne.prototype.init = function(a, b) {
    ...
    te.prototype.add = function(a, b, c, d, e) {
        ...
        var g = ue(a, b, d, e); - 1 < g ? (b = a[g], c || (b.xa = !1)) : (b = new re(b, this.src, f, !!d, e), b.xa = c, a.push(b));
        return b
    };
    te.prototype.remove = function(a, b, c, d) {
        ...
        b = ue(e, b, c, d);
        return -1 < b ? (se(e[b]), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.listeners[a], this.i--), !0) : !1
    };

    function ve(a, b) {
        var c = b.type;
        c in a.listeners && eb(a.listeners[c], b) && (se(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.i--))
    }

    function ue(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.na && f.listener == b && f.capture == !!c && f.Ba == d) return e
        }
        return -1
    };
    ...
    function ze(a, b, c, d, e) {
        ...
        else c = Be(c), a && a[pe] ? a.aa(b, c, Pa(d) ? !!d.capture : !!d, e) : Ce(a, b, c, !1, d, e)
    }
    ...
    function Ae(a, b, c, d, e) {
        ...
        else c = Be(c), a && a[pe] ? a.i.add(String(b), c, !0, Pa(d) ? !!d.capture : !!d, e) : Ce(a, b, c, !0, d, e)
    }

    function He(a, b, c, d, e) {
        if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) He(a, b[f], c, d, e);
        else(d = Pa(d) ? !!d.capture : !!d, c = Be(c), a && a[pe]) ? a.i.remove(String(b), c, d, e) : a && (a = De(a)) && (b = a.listeners[b.toString()], a = -1, b && (a = ue(b, c, d, e)), (c = -1 < a ? b[a] : null) && Ie(c))
    }
    ...
    function Ie(a) {
        if ("number" !== typeof a && a && !a.na) {
            ...
            if (b && b[pe]) ve(b.i, a);
                ...
                ye--;
                (c = De(b)) ? (ve(c, a), 0 == c.i && (c.src = null, b[we] = null)) : se(a)
            }
        }
    }
    ...
    function Le(a, b) {
        ...
        a = a.Z;
        c = b.type || b;
        "string" === typeof b ? b = new le(b, a) : b instanceof le ? b.target = b.target || a : (e = b, b = new le(c, a), pb(b, e));
        e = !0;
        if (d)
        ...
        b.l || (g = b.i = a, e = Me(g, c, !0, b) && e, b.l || (e = Me(g, c, !1, b) && e));
        if (d)
            for (f = 0; !b.l && f < d.length; f++) g = b.i = d[f], e = Me(g, c, !1, b) && e
    }
    Ke.prototype.fa = function() {
        Ke.P.fa.call(this);
        if (this.i) {
            ...
            for (c in a.listeners) {
                for (var d = a.listeners[c], e = 0; e < d.length; e++) ++b, se(d[e]);
    ...
    Ke.prototype.aa = function(a, b, c, d) {
    ...
    function Pe(a) {
        a.I = a.L.S(function() {
            var b;
            return y(function(c) {
                if (1 == c.i) return a.j ? (null == (b = window.navigator) ? 0 : b.onLine) ? c.B(3) : x(c, Oe(a), 3) : x(c, Oe(a), 3);
                Pe(a);
                c.i = 0
            })
        }, 3E4)
    ...
    function Oe(a, b) {
        return a.v ? a.v : a.v = new Promise(function(c) {
            ...
            return y(function(h) {
                switch (h.i) {
                    case 1:
                        return d = window.AbortController ? new window.AbortController : void 0, f = null == (e = d) ? void 0 : e.signal, g = !1, wa(h, 2, 3), d && (a.m = a.L.S(function() {
                            d.abort()
                    ...
                    case 3:
                        Aa(h);
                        a.v = void 0;
                        a.m && (a.L.da(a.m), a.m = 0);
                        g !== a.j && (a.j = g, a.j ? Le(a, "networkstatus-online") : Le(a, "networkstatus-offline"));
                        c(g);
                        Ba(h);
                        break;
                    case 2:
    ...
    function Te(a) {
        -1 === a.i && (a.i = cb(a.data_, function(b, c, d) {
    ...
    v(bf, L);
    var Ve = [10, 6];
    var ff = "platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" ");
    ...
    function jf() {
        ...
        a = a.navigator.userAgentData.getHighEntropyValues(ff).then(function(c) {
    ...
    function kf(a) {
        var b;
        return cf(af(Ze(We(df(Ye(ef($e(Xe(new Ue, a.architecture || ""), a.bitness || ""), a.mobile || !1), a.model || ""), a.platform || ""), a.platformVersion || ""), a.uaFullVersion || ""), (null == (b = a.fullVersionList) ? void 0 : b.map(function(c) {
            var d = new bf;
            d = I(d, 1, c.brand);
    ...
    function lf() {
        var a, b;
        return null != (b = null == (a = jf()) ? void 0 : a.then(function(c) {
            return kf(c)
        })) ? b : null
    };
    ...
    Cf.prototype.update = function(a, b) {
        if (null != a) {
            void 0 === b && (b = a.length);
            for (var c = b - this.blockSize, d = 0, e = this.u, f = this.j; d < b;) {
                if (0 == f)
                    for (; d <= c;) Df(this, a, d), d += this.blockSize;
                if ("string" === typeof a)
                    for (; d < b;) {
    ...
    function Hf(a) {
        if (a instanceof If || a instanceof Jf || a instanceof Kf) return a;
        if ("function" == typeof a.next) return new If(function() {
            return a
        });
        if ("function" == typeof a[Symbol.iterator]) return new If(function() {
            return a[Symbol.iterator]()
        });
        if ("function" == typeof a.M) return new If(function() {
            return a.M()
        });
    ...
    n.delete = function(a) {
        return kg(this.j, a) ? (delete this.j[a], --this.size, this.l++, this.i.length > 2 * this.size && jg(this), !0) : !1
    };
    ...
    function jg(a) {
        ...
        if (a.size != a.i.length) {
            var e = {};
            for (c = b = 0; b < a.i.length;) d = a.i[b], kg(e, d) || (a.i[c++] = d, e[d] = 1), b++;
            a.i.length = c
        }
    }
    n.get = function(a, b) {
        return kg(this.j, a) ? this.j[a] : b
    };
    n.set = function(a, b) {
        kg(this.j, a) || (this.size += 1, this.i.push(a), this.l++);
        this.j[a] = b
    };
    ...
    n.keys = function() {
        return Hf(this.M(!0)).i()
    };
    n.values = function() {
        return Hf(this.M(!1)).i()
    };
    n.entries = function() {
        var a = this;
        return Af(this.keys(), function(b) {
            return [b, a.get(b)]
        })
    };
    n.M = function(a) {
    ...
    og.prototype.then = function(a, b, c) {
        return tg(this, "function" === typeof a ? a : null, "function" === typeof b ? b : null, c)
    };
        ...
        if (0 == a.i)
            if (a.l) {
                ...
                if (c.j) {
                    ...
                    e && (0 == c.i && 1 == d ? vg(c, b) : (f ? (d = f, d.next == c.m && (c.m = d), d.next = d.next.next) : wg(c), xg(c, e, 3, b)))
                }
                a.l = null
            } else pg(a, 3, b)
    }
    ...
    function pg(a, b, c) {
        if (0 == a.i) {
            ...
            g || (a.v = c, a.i = b, a.l = null, zg(a), 3 != b || c instanceof ug || Bg(a, c))
        }
    }
    ...
    og.prototype.D = function() {
        for (var a; a = wg(this);) xg(this, a, this.i, this.v);
        this.o = !1
    };
    ...
    function xg(a, b, c, d) {
        ...
        if (b.i) b.i.l = null, Cg(b, c, d);
        else try {
            b.l ? b.j.call(b.context) : Cg(b, c, d)
        } catch (e) {
            Dg.call(null, e)
        }
        nf(rg, b)
    ...
    n.qa = function(a) {
        ...
        if (b) {
            var c = this.j[b];
            0 != this.o ? (this.m.push(a), this.i[a + 1] = function() {}) : (c && eb(c, a), delete this.i[a], delete this.i[a + 1], delete this.i[a + 2])
        }
        return !!b
    };
    n.ha = function(a, b) {
    ...
    n.clear = function(a) {
        if (a) {
            var b = this.j[a];
            b && (b.forEach(this.qa, this), delete this.j[a])
    ...
    Hg.prototype.set = function(a, b) {
        void 0 === b ? this.i.remove(a) : this.i.set(a, mg(b))
    };
    ...
    Ig.prototype.set = function(a, b) {
        Ig.P.set.call(this, a, Kg(b))
    };
    Ig.prototype.j = function(a) {
        a = Ig.P.get.call(this, a);
    ...
    Lg.prototype.set = function(a, b, c) {
        ...
        Lg.P.set.call(this, a, b)
    };
    Lg.prototype.j = function(a) {
        var b = Lg.P.j.call(this, a);
        if (b) {
            var c = b.creation,
                d = b.expiration;
            if (d && d < Date.now() || c && c > Date.now()) Lg.prototype.remove.call(this, a);
            else return b
        }
    };
    ...
    function Qg(a, b) {
        ...
        if (c) {
            Rg || (Rg = new hg);
            this.i = Rg.get(a);
            this.i || (b ? this.i = document.getElementById(b) : (this.i = document.createElement("userdata"), this.i.addBehavior("#default#userData"), document.body.appendChild(this.i)), Rg.set(a, this.i));
            try {
                this.i.load(this.j)
            } catch (d) {
                this.i = null
    ...
    n.set = function(a, b) {
        this.i.setAttribute(Tg(a), b);
        Ug(this)
    };
    n.get = function(a) {
        a = this.i.getAttribute(Tg(a));
        if ("string" !== typeof a && null !== a) throw "Storage mechanism: Invalid value was encountered";
        return a
    };
    n.remove = function(a) {
        this.i.removeAttribute(Tg(a));
        Ug(this)
    };
    n.M = function(a) {
        var b = 0,
        ...
        d.next = function() {
            if (b >= c.length) return Ff;
            var e = c[b++];
            if (a) return Gf(decodeURIComponent(e.nodeName.replace(/\./g, "%")).slice(1));
            e = e.nodeValue;
            if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered";
            return Gf(e)
        };
    ...
    Vg.prototype.M = function(a) {
        ...
        d.next = function() {
            ...
            return Gf(a ? e.slice(c.i.length) : c.j.get(e))
        };
        return d
    };
    ...
    Wg.prototype.V = function() {
        return sd(this, 2 === ld(this, Xg) ? 2 : -1)
    };
    Wg.prototype.setValue = function(a) {
        return kd(this, 2, Xg, a)
    };
    var Xg = [2, 3, 4, 5, 6];
    ...
    v(bh, L);
    bh.prototype.getPlayerType = function() {
        return id(this, 36)
    };
    bh.prototype.setHomeGroupInfo = function(a) {
        return J(this, $g, 81, a)
    };
    var ch = [9, 66, 24, 32, 86, 100, 101];
    ...
    v(fh, L);
    fh.prototype.setToken = function(a) {
        return I(this, 2, a)
    };
    ...
    v(gh, L);
    gh.prototype.setSafetyMode = function(a) {
        return I(this, 5, a)
    };
    var hh = [12];
    ...
    var kh = {
        ...
        Tb: "WEB_DISPLAY_MODE_MINIMAL_UI",
        Ub: "WEB_DISPLAY_MODE_STANDALONE",
        Sb: "WEB_DISPLAY_MODE_FULLSCREEN"
    };
    ...
    nh.prototype.setValue = function(a) {
        return I(this, 2, a)
    };
    var mh = [4, 5];
    ...
    var Ah = [23, 24, 11, 6, 7, 5, 2, 3, 13, 20, 21, 22, 28, 32, 37, 229, 241, 45, 59, 225, 288, 72, 73, 78, 208, 156, 202, 215, 74, 76, 79, 80, 111, 85, 91, 97, 100, 102, 105, 119, 126, 127, 136, 146, 148, 151, 157, 158, 159, 163, 164, 168, 176, 222, 383, 177, 178, 179, 411, 184, 188, 189, 190, 191, 193, 194, 195, 196, 197, 198, 199, 200, 201, 402, 320, 203, 204, 205, 206, 258, 259, 260, 261, 327, 209, 219, 226, 227, 232, 233, 234, 240, 244, 247, 248, 249, 251, 256, 257, 266, 254, 255, 270, 272, 278, 291, 293, 300, 304, 308, 309, 310, 311, 313, 314, 319, 321, 323, 324, 328, 330, 331, 332, 334, 337, 338, 340, 344, 348, 350, 351, 352,
        353, 354, 355, 356, 357, 358, 361, 363, 364, 368, 369, 370, 373, 374, 375, 378, 380, 381, 388, 389, 403, 410, 412, 429, 413, 414, 415, 416, 417, 418, 430, 423, 424, 425, 426, 427, 431, 117, 439, 441, 448
    ];
    ...
    Ch.prototype.getPlaylistId = function() {
        return sd(this, 2 === ld(this, Dh) ? 2 : -1)
    };
    var Dh = [1, 2];
    ...
    var Fh = [3];
    var Gh = A.window,
        Hh, Ih, Jh = (null == Gh ? void 0 : null == (Hh = Gh.yt) ? void 0 : Hh.config_) || (null == Gh ? void 0 : null == (Ih = Gh.ytcfg) ? void 0 : Ih.data_) || {};
    B("yt.config_", Jh);

    function Kh() {
        var a = arguments;
        1 < a.length ? Jh[a[0]] = a[1] : 1 === a.length && Object.assign(Jh, a[0])
    }

    function P(a, b) {
        return a in Jh ? Jh[a] : b
    }
    ...
    function Qh(a, b, c, d) {
        ...
        e ? e(a, "ERROR", b, c, d) : (e = P("ERRORS", []), e.push([a, "ERROR", b, c, d]), Kh("ERRORS", e));
        Oh(a)
    }

    function Rh(a, b, c, d) {
        var e = C("yt.logging.errors.log");
        e ? e(a, "WARNING", b, c, d) : (e = P("ERRORS", []), e.push([a, "WARNING", b, c, d]), Kh("ERRORS", e))
    };
    var Sh = 0;
    ...
    var Wh = A.ytEventsEventsCounter || {
        count: 0
    };
    B("ytEventsEventsCounter", Wh);
        ...
        a && ("string" == typeof a && (a = [a]), E(a, function(b) {
            if (b in lb) {
                var c = lb[b],
                    ...
                    f = c[3];
                c = c[4];
                d.removeEventListener ? Zh() || "boolean" === typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete lb[b]
            }
        }))
    }
    ...
    function $h(a, b, c, d) {
        ...
        g = Ph(g);
        a.addEventListener ? ("mouseenter" == b && f ? b = "mouseover" : "mouseleave" == b && f ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), Zh() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
        lb[e] = [a, b, c, g, d];
        return e
    };

    function ai(a, b) {
        "function" === typeof a && (a = Ph(a));
        ...
        for (var c = {}, d = 0, e = b.length; d < e; d++) {
            ...
            if (1 == f.length && f[0] || 2 == f.length) try {
                ...
                k.args = [{
                    ...
                    value: f[1],
                    query: a,
                    method: gi == m ? "unchanged" : m
                }];
                di.hasOwnProperty(l) || Rh(k)
            }
        }
        return c
    }
    ...
    function ki(a) {
        ...
        var c = a.match(Ob)[1] || null,
            d = Ub(a);
        c && d ? (a = a.match(Ob), b = b.match(Ob), a = a[3] == b[3] && a[1] == b[1] && a[4] == b[4]) : a = d ? Ub(b) == d && (Number(b.match(Ob)[4] || null) || null) == (Number(a.match(Ob)[4] || null) || null) : !0;
        return a
    }

    function fi(a) {
        return a && a.match(ci) ? a : decodeURIComponent(a.replace(/\+/g, " "))
    };
    ...
    function oi(a) {
        ...
        try {
            ...
            e.u_his = h;
            var k;
            e.u_h = null == (k = zd.screen) ? void 0 : k.height;
            var l;
            e.u_w = null == (l = zd.screen) ? void 0 : l.width;
            var m;
            e.u_ah = null == (m = zd.screen) ? void 0 : m.availHeight;
            var p;
            e.u_aw = null ==
                (p = zd.screen) ? void 0 : p.availWidth;
            var t;
            e.u_cd = null == (t = zd.screen) ? void 0 : t.colorDepth
        } catch (Y) {}
        h = b.i;
        try {
            var q = h.screenX;
        ...
        q = [O, kb, q, w, qc, ya, z, G, K, M];
        w = b.i.top;
        try {
            var ta = (w || window).document,
                Z = "CSS1Compat" ==
                ta.compatMode ? ta.documentElement : ta.body;
            var da = (new Id(Z.clientWidth, Z.clientHeight)).round()
        } catch (Y) {
            da = new Id(-12245933, -12245933)
        }
        ta = da;
        da = {};
        var ea = void 0 === ea ? A : ea;
        Z = new Se;
        ea.SVGElement && ea.document.createElementNS && Z.set(0);
        w = Rd();
        w["allow-top-navigation-by-user-activation"] && Z.set(1);
        w["allow-popups-to-escape-sandbox"] && Z.set(2);
        ea.crypto && ea.crypto.subtle && Z.set(3);
        ea.TextDecoder && ea.TextEncoder && Z.set(4);
        ea = Te(Z);
        da.bc = ea;
        da.bih = ta.height;
        da.biw = ta.width;
        ...
        b = (da.vis =
            b.prerendering ? 3 : {
                ...
                preview: 4,
                unloaded: 5
            }[b.visibilityState || b.webkitVisibilityState || b.mozVisibilityState || ""] || 0, da.wgl = !!zd.WebGLRenderingContext, da);
        c = d.call(c, e, b);
        c.ca_type = "image";
        a && (c.bid = a);
        return c
    ...
    Date.now();
    var qi = "XMLHttpRequest" in A ? function() {
    ...
    var si = {
        ...
        ti = "app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ").concat(ia($d)),
        ui = !1;
    ...
    function vi(a, b) {
        ...
        for (e in si) {
            ...
            !f || !c && Ub(a) || d && void 0 !== b[e] || (b[e] = f)
        }
        "X-Goog-EOM-Visitor-Id" in b && "X-Goog-Visitor-Id" in b && delete b["X-Goog-Visitor-Id"];
        if (c || !Ub(a)) b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset());
        if (c || !Ub(a)) {
            try {
        ...
        document.location.hostname.endsWith("youtubeeducation.com") ||
            !c && Ub(a) || (b["X-YouTube-Ad-Signals"] = hi(oi()));
        return b
    }
    ...
    function wi(a) {
        var b = window.location.search,
            c = Ub(a);
        R("debug_handle_relative_url_for_query_forward_killswitch") || !c && ki(a) && (c = document.location.hostname);
        ...
        var d = zi(a, b),
            ...
            f = Ai(a, function(k) {
                if (!e) {
                    ...
                    if (l || p || t) m = Bi(a, c, k, b.convertToSafeHtml);
    ...
    function yi(a, b) {
        ...
        if (b = b.urlParams) b[c] && delete b[c], a = ji(a, b || {}, !0);
        return a
    }
    ...
    function zi(a, b) {
        ...
        b.excludeXsrf || Ub(a) && !b.withCredentials && Ub(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.postParams && b.postParams[g] || (f || (f = {}), f[c] = d);
        ...
        if (!(a = e) && (a = f)) {
            ...
            a = !f
        }!ui && a && "POST" != b.method && (ui = !0, Qh(Error("AJAX request with postData should use POST")));
        return e
    }
        ...
        switch (b) {
            case "JSON":
                try {
                    ...
                    throw d = Error("Error reading responseText"), d.params = a, Rh(d), g;
                }
                a = c.getResponseHeader("Content-Type") || "";
                f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f));
                break;
            case "XML":
                if (a = (a = c.responseXML) ? Ci(a) : null) e = {}, E(a.getElementsByTagName("*"), function(g) {
                    e[g.tagName] = Di(g)
                })
        }
        d && Ei(e);
    ...
    function Ai(a, b, c, d, e, f, g) {
        function h() {
            4 == (k && "readyState" in k ? k.readyState : 0) && b && Ph(b)(k)
        }
        c = void 0 === c ? "GET" : c;
        d = void 0 === d ? "" : d;
        var k = ri();
        ...
        R("debug_forward_web_query_parameters") && (a = wi(a));
        k.open(c, a, !0);
        f && (k.responseType = f);
    ...
    function Ni(a, b, c) {
        ...
        return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : ai(a, c || 0)
    }
    ...
    function Ti() {
        ...
        throw new Ri("Datasync ID not set", "unknown");
    };
    var Ui = rc || sc;

    function Vi(a) {
        var b = new Pg;
        (b = b.isAvailable() ? a ? new Vg(b, a) : b : null) || (a = new Qg(a || "UserDataSharedStore"), b = a.isAvailable() ? a : null);
        this.i = (a = b) ? new Lg(a) : null;
    ...
    Vi.prototype.get = function(a, b) {
        ...
        if (d && (c = ge.get("" + a, void 0)) && (c = unescape(c), b)) try {
            c = JSON.parse(c)
        } catch (e) {
    ...
    Vi.prototype.remove = function(a) {
        ...
        var b = this.j;
        ge.remove("" + a, "/", void 0 === b ? "youtube.com" : b)
    };
    var Wi = function() {
        var a;
        return function() {
    ...
    function Xi() {
        var a;
        return null == (a = Wi()) ? void 0 : a.get("LAST_RESULT_ENTRY_KEY", !0)
    };
    var Yi = [],
        Zi = !1;
    ...
    var dj = {},
        ej = (dj.AUTH_INVALID = "No user identifier specified.", dj.EXPLICIT_ABORT = "Transaction was explicitly aborted.", dj.IDB_NOT_SUPPORTED = "IndexedDB is not supported.", dj.MISSING_INDEX = "Index not created.", dj.MISSING_OBJECT_STORES = "Object stores not created.", dj.DB_DELETED_BY_MISSING_OBJECT_STORES = "Database is deleted because expected object stores were not created.", dj.DB_REOPENED_BY_MISSING_OBJECT_STORES = "Database is reopened because expected object stores were not created.", dj.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons.",
            dj.QUOTA_EXCEEDED = "The current transaction exceeded its quota limitations.", dj.QUOTA_MAYBE_EXCEEDED = "The current transaction may have failed because of exceeding quota limitations.", dj.EXECUTE_TRANSACTION_ON_CLOSED_DB = "Can't start a transaction on a closed database", dj.INCOMPATIBLE_DB_VERSION = "The binary is incompatible with the database version", dj),
        fj = {},
        gj = (fj.AUTH_INVALID = "ERROR", fj.EXECUTE_TRANSACTION_ON_CLOSED_DB = "WARNING", fj.EXPLICIT_ABORT = "IGNORED", fj.IDB_NOT_SUPPORTED = "ERROR", fj.MISSING_INDEX =
            "WARNING", fj.MISSING_OBJECT_STORES = "ERROR", fj.DB_DELETED_BY_MISSING_OBJECT_STORES = "WARNING", fj.DB_REOPENED_BY_MISSING_OBJECT_STORES = "WARNING", fj.QUOTA_EXCEEDED = "WARNING", fj.QUOTA_MAYBE_EXCEEDED = "WARNING", fj.UNKNOWN_ABORT = "WARNING", fj.INCOMPATIBLE_DB_VERSION = "WARNING", fj),
        hj = {},
        ij = (hj.AUTH_INVALID = !1, hj.EXECUTE_TRANSACTION_ON_CLOSED_DB = !1, hj.EXPLICIT_ABORT = !1, hj.IDB_NOT_SUPPORTED = !1, hj.MISSING_INDEX = !1, hj.MISSING_OBJECT_STORES = !1, hj.DB_DELETED_BY_MISSING_OBJECT_STORES = !1, hj.DB_REOPENED_BY_MISSING_OBJECT_STORES = !1, hj.QUOTA_EXCEEDED = !1, hj.QUOTA_MAYBE_EXCEEDED = !0, hj.UNKNOWN_ABORT = !0, hj.INCOMPATIBLE_DB_VERSION = !1, hj);
    ...
    function jj(a, b) {
        T.call(this, "MISSING_OBJECT_STORES", {
            ...
            foundObjectStores: a
        }, ej.MISSING_OBJECT_STORES);
        Object.setPrototypeOf(this, jj.prototype)
    }
    v(jj, T);
    ...
    function kj(a, b) {
        ...
        this.index = a;
        this.objectStore = b;
        Object.setPrototypeOf(this, kj.prototype)
    }
    v(kj, Error);
    var lj = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];
    ...
    function mj(a, b, c, d) {
        ...
        if (e instanceof kj) return new T("MISSING_INDEX", Object.assign({}, a, {
            objectStore: e.objectStore,
            index: e.index
        }));
        if ("InvalidStateError" === e.name && lj.some(function(f) {
    ...
    U.all = function(a) {
        return new U(new qj(function(b, c) {
            var d = [],
                e = a.length;
            0 === e && b(d);
            for (var f = {
                    ...
                    ca: f.ca
                }, ++f.ca) rj(U.resolve(a[f.ca]).then(function(g) {
                return function(h) {
                    d[g.ca] = h;
                    e--;
                    0 === e && b(d)
    ...
    U.prototype.then = function(a, b) {
        var c = this,
            d = null != a ? a : pj,
            e = null != b ? b : oj;
        return new U(new qj(function(f, g) {
            "PENDING" === c.state.status ? (c.i.push(function() {
                sj(c, c, d, f, g)
            }), c.onRejected.push(function() {
                tj(c, c, e, f, g)
            })) : "FULFILLED" === c.state.status ? sj(c, c, d, f, g) : "REJECTED" === c.state.status && tj(c, c, e, f, g)
        }))
    };
    ...
    function sj(a, b, c, d, e) {
        try {
            ...
            f instanceof U ? uj(a, b, f, d, e) : d(f)
        } catch (g) {
            e(g)
        }
    }
    ...
    function xj(a, b) {
        return new U(new qj(function(c, d) {
            function e() {
                var f = a ? b(a) : null;
                f ? f.then(function(g) {
                    a = g;
    ...
    var yj = window,
        W = yj.ytcsi && yj.ytcsi.now ? yj.ytcsi.now : yj.performance && yj.performance.timing && yj.performance.now && yj.performance.timing.navigationStart ? function() {
            return yj.performance.timing.navigationStart + yj.performance.now()
        } : function() {
        ...
        return y(function(G) {
            switch (G.i) {
                ...
                case 2:
                    ...
                    return x(G, K, 6);
                case 6:
                    return m = G.j, p = Math.round(W()), uk(a, k, p, g, void 0, b.join(), e), G.return(m);
                case 4:
                    t = za(G);
                    q = Math.round(W());
                    w = mj(t, a.i.name, b.join(), a.i.version);
                    if ((z = w instanceof T && !w.i) || g >= f) uk(a, k, q, g, w, b.join(), e), h = w;
                    G.B(2);
                    break;
                case 3:
    ...
    function uk(a, b, c, d, e, f, g) {
        b = c - b;
        e ? (e instanceof T && ("QUOTA_EXCEEDED" === e.type || "QUOTA_MAYBE_EXCEEDED" === e.type) && aj("QUOTA_EXCEEDED", {
            dbName: cj(a.i.name),
            objectStoreNames: f,
            transactionCount: a.transactionCount,
            transactionMode: g.mode
        }), e instanceof T && "UNKNOWN_ABORT" === e.type && (c -= a.l, 0 > c && c >= Math.pow(2, 31) && (c = 0), aj("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
            transactionDuration: b,
            transactionCount: a.transactionCount,
            dbDuration: c
        }), a.j = !0), vk(a, !1, d, f, b, g.tag), $i(e)) : vk(a, !0, d, f, b, g.tag)
    }

    function vk(a, b, c, d, e, f) {
        aj("TRANSACTION_ENDED", {
            objectStoreNames: d,
    ...
    n.delete = function(a) {
        return a instanceof IDBKeyRange ? wk(this, a) : V(this.i.delete(a))
    };
    n.get = function(a) {
    ...
    n.index = function(a) {
        try {
            return new yk(this.i.index(a))
        } catch (b) {
            if (b instanceof Error && "NotFoundError" === b.name) throw new kj(a, this.i.name);
            throw b;
        }
    };
    n.getName = function() {
    ...
    sk.prototype.abort = function() {
        this.i.abort();
        this.j = !0;
        throw new T("EXPLICIT_ABORT");
    };
    sk.prototype.objectStore = function(a) {
        a = this.i.objectStore(a);
        var b = this.l.get(a);
        b || (b = new Cj(a), this.l.set(a, b));
        return b
    };
    ...
    function zk(a) {
        return V(a).then(function(b) {
            return b ? new Bk(a, b) : null
        })
    }
    n = Bk.prototype;
    n.advance = function(a) {
        this.cursor.advance(a);
        return zk(this.request)
    };
        ...
        return new Promise(function(d, e) {
            ...
            g.addEventListener("upgradeneeded", function(q) {
                try {
                    ...
                    q.dataLoss && "none" !== q.dataLoss && aj("IDB_DATA_CORRUPTED", {
                        reason: q.dataLossMessage || "unknown reason",
                        dbName: cj(a)
                    });
                    var w = f(),
                        z = new sk(g.transaction);
                    m && m(w, function(G) {
    ...
    Gk.prototype.l = function(a, b, c) {
        c = void 0 === c ? {} : c;
        return Dk(a, b, c)
    };
    Gk.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return Ek(this.name, a)
    };
    ...
    function Ik(a, b) {
        if (!b) throw nj("openWithToken", cj(a.name));
        return Jk(a)
    }
    ...
    function Jk(a) {
        function b() {
            ...
            return y(function(z) {
                switch (z.i) {
                    case 1:
                        return g = null != (f = Error().stack) ? f : "", wa(z, 2), x(z, a.l(a.name, a.options.version, d), 4);
                    case 4:
                        h = z.j;
                        for (var G = a.options, K = [], M = u(Object.keys(G.ma)), O = M.next(); !O.done; O = M.next()) {
                            O = O.value;
                            var kb = G.ma[O],
                                qc = void 0 === kb.Cb ? Number.MAX_VALUE : kb.Cb;
                            !(h.i.version >= kb.Ja) || h.i.version >= qc || h.i.objectStoreNames.contains(O) || K.push(O)
                        }
                        k = K;
                        if (0 === k.length) {
                            z.B(5);
                        ...
                        if (!(a.u < mi("ytidb_remake_db_retries", 1))) {
                            z.B(6);
                            break
                        }
                        a.u++;
                        if (!R("ytidb_remake_db_enable_backoff_delay")) {
                            z.B(7);
                            break
                        }
                        return x(z, Fk(a.j), 8);
                    case 8:
                        a.j *= 2;
                    case 7:
                        return x(z, a.delete(), 9);
                    case 9:
                        return $i(new T("DB_DELETED_BY_MISSING_OBJECT_STORES", {
                            dbName: a.name,
                            expectedObjectStores: l,
                            foundObjectStores: m
                        })), z.return(b());
                    ...
                    case 2:
                        ...
                        return x(z, a.l(a.name, void 0, Object.assign({}, d, {
                            upgrade: void 0
                        })), 11);
                    case 11:
                        t = z.j;
                        ...
                        return z.return(t);
                    case 10:
                        throw c(), p instanceof Error && !R("ytidb_async_stack_killswitch") && (p.stack = p.stack + "\n" + g.substring(g.indexOf("\n") + 1)), mj(p, a.name, "", null != (w = a.options.version) ? w : -1);
                }
            })
        }
    ...
    function Lk(a, b) {
        var c;
        return y(function(d) {
            if (1 == d.i) return x(d, Ik(Kk, b), 2);
            c = d.j;
            return d.return(Aj(c, ["databases"], {
                J: !0,
                mode: "readwrite"
            }, function(e) {
    ...
    function Mk(a, b) {
        var c;
        return y(function(d) {
            if (1 == d.i) return a ? x(d, Ik(Kk, b), 2) : d.return();
            c = d.j;
    ...
    function Nk(a, b) {
        var c, d;
        return y(function(e) {
            return 1 == e.i ? (c = [], x(e, Ik(Kk, b), 2)) : 3 != e.i ? (d = e.j, x(e, Aj(d, ["databases"], {
                J: !0,
                mode: "readonly"
            }, function(f) {
                c.length = 0;
                return xk(f.objectStore("databases"), {}, function(g) {
                    a(g.V()) && c.push(g.V());
                    return g.continue()
                })
            }), 3)) : e.return(c)
        ...
        return y(function(e) {
            switch (e.i) {
                case 1:
                    ...
                    var f;
                    if (f = Ui) f = /WebKit\/([0-9]+)/.exec(Kb()), f = !!(f && 600 <= parseInt(f[1], 10));
                    ...
                    return x(e, Lk(d, Qk), 4);
                case 4:
                    return x(e, Mk("yt-idb-test-do-not-use", Qk), 5);
                case 5:
                    return e.return(!0);
                case 2:
    ...
    function Sk() {
        if (void 0 !== Pk) return Pk;
        Zi = !0;
        return Pk = Rk().then(function(a) {
            Zi = !1;
            var b;
            if (null != (b = Wi()) && b.i) {
                var c;
                b = {
                    hasSucceededOnce: (null == (c = Xi()) ? void 0 : c.hasSucceededOnce) || a
                };
                var d;
                null == (d = Wi()) || d.set("LAST_RESULT_ENTRY_KEY", b, 2592E3, !0)
            }
            return a
        })
    }
    ...
    function Tk() {
        ...
        return a ? Promise.resolve(a) : Sk().then(function(b) {
            (b = b ? Qk : void 0) && B("ytglobal.idbToken_", b);
            return b
        })
    };
    new ng;
    ...
    function Uk(a) {
        if (!Si()) throw a = new T("AUTH_INVALID", {
            dbName: a
        }), $i(a), a;
        var b = Ti();
        return {
    ...
    function Vk(a, b, c, d) {
        ...
        return y(function(m) {
            switch (m.i) {
                case 1:
                    return f = null != (e = Error().stack) ? e : "", x(m, Tk(), 2);
                case 2:
                    g = m.j;
                    if (!g) throw h = nj("openDbImpl", a, b), R("ytidb_async_stack_killswitch") || (h.stack = h.stack + "\n" + f.substring(f.indexOf("\n") + 1)), $i(h), h;
                    bj(a);
                    k = c ? {
                        actualName: a,
                        publicName: a,
                    ...
                    return x(m, Lk(k, g), 5);
                case 5:
                    return x(m, Dk(k.actualName, b, d), 6);
                case 6:
                    return m.return(m.j);
                case 3:
                    return l = za(m), wa(m, 7), x(m, Mk(k.actualName, g), 9);
                case 9:
                    xa(m,
                        8);
                    break;
    ...
    function Yk(a, b) {
        ...
        var c, d;
        return y(function(e) {
            if (1 == e.i) return x(e, Tk(), 2);
            if (3 != e.i) {
                c = e.j;
                if (!c) return e.return();
                bj(a);
                d = Uk(a);
                return x(e, Ek(d.actualName, b), 3)
            }
            return x(e, Mk(d.actualName, c), 0)
        })
    }
    ...
    function Zk(a, b, c) {
        a = a.map(function(d) {
            return y(function(e) {
                return 1 == e.i ? x(e, Ek(d.actualName, b), 2) : x(e, Mk(d.actualName, c), 0)
            })
        });
    ...
    bl.prototype.l = function(a, b, c) {
        c = void 0 === c ? {} : c;
        return (this.options.Sa ? Xk : Wk)(a, b, Object.assign({}, c))
    };
    bl.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return (this.options.Sa ? al : Yk)(this.name, a)
    };
    ...
    function fl() {
        return "INNERTUBE_API_KEY" in Jh && "INNERTUBE_API_VERSION" in Jh
    }
    ...
    function gl() {
        return {
            ...
            La: P("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
            Za: P("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
            wb: P("INNERTUBE_CONTEXT_CLIENT_NAME", 1),
            innertubeContextClientVersion: P("INNERTUBE_CONTEXT_CLIENT_VERSION"),
            bb: P("INNERTUBE_CONTEXT_HL"),
            ab: P("INNERTUBE_CONTEXT_GL"),
            xb: P("INNERTUBE_HOST_OVERRIDE") || "",
            zb: !!P("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
            yb: !!P("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
    ...
    function hl(a) {
        ...
        kl(a, void 0, b);
        ll(void 0, b);
        R("start_sending_config_hash") && ml(void 0, b);
        ...
        a = Object;
        c = a.assign;
        for (var d = b.client, e = {}, f = u(Object.entries(ii(P("DEVICE", "")))), g = f.next(); !g.done; g = f.next()) {
            var h = u(g.value);
            g = h.next().value;
            h = h.next().value;
    ...
    function nl(a) {
        ...
        if (a.La) {
            ...
            J(c, Yg, 62, e)
        }(d = A.devicePixelRatio) && 1 != d && I(c, 65, d);
        d = P("EXPERIMENTS_TOKEN", "");
        "" !== d && I(c, 54, d);
        d = ni();
        if (0 < d.length) {
            e = new dh;
        ...
        kl(a, c);
        ll(c);
        R("start_sending_config_hash") && ml(c);
        P("DELEGATED_SESSION_ID") && !R("pageid_as_header_web") && (a = new gh, I(a, 3, P("DELEGATED_SESSION_ID")));
        a = u(Object.entries(ii(P("DEVICE", ""))));
        for (d = a.next(); !d.done; d = a.next()) e = u(d.value), d = e.next().value, e = e.next().value, "cbrand" === d ? I(c, 12, e) : "cmodel" === d ? I(c, 13, e) : "cbr" === d ? I(c, 87, e) : "cbrver" === d ? I(c, 88, e) : "cos" === d ? I(c, 18, e) : "cosver" === d ? I(c, 19, e) : "cplatform" === d && I(c, 42, e);
        J(b, bh, 1, c);
        return b
    }
    ...
    function il(a, b, c) {
        ...
        if ("WEB" === a || "MWEB" === a || 1 === a || 2 === a)
            if (b) {
                c = md(b, Zg, 96) || new Zg;
                var d = Fi();
                d = Object.keys(kh).indexOf(d);
                d = -1 === d ? null : d;
                null !== d && I(c, 3, d);
                J(b, Zg, 96, c)
            } else c && (c.client.mainAppWebInfo = null != (d = c.client.mainAppWebInfo) ? d : {}, c.client.mainAppWebInfo.webDisplayMode = Fi())
    }

    function jl(a, b) {
        var c;
        if (R("web_log_memory_total_kbytes") && (null == (c = A.navigator) ? 0 : c.deviceMemory)) {
            var d;
    ...
    function ll(a, b) {
        a: {
            var c = Ki();
            if (c) {
                var d = Gi[c.type || "unknown"] || "CONN_UNKNOWN";
                c = Gi[c.effectiveType || "unknown"] || "CONN_UNKNOWN";
        ...
        d && (a ? I(a, 61, Hi[d]) : b && (b.client.connectionType = d));R("web_log_effective_connection_type") && (d = Ki(), d = null != d && d.effectiveType ? Ji.hasOwnProperty(d.effectiveType) ? Ji[d.effectiveType] : "EFFECTIVE_CONNECTION_TYPE_UNKNOWN" : void 0, d && (a ? I(a, 94, Ii[d]) :
    ...
    function ol(a, b, c) {
        ...
        (b = c.Xb || P("AUTHORIZATION")) || (a ? b = "Bearer " + C("gapi.auth.getToken")().Wb : b = je([]));
        b && (d.Authorization = b, d["X-Goog-AuthUser"] = P("SESSION_INDEX", 0), R("pageid_as_header_web") && (d["X-Goog-PageId"] = P("DELEGATED_SESSION_ID")));
        return d
    }
    ...
    function sl(a, b, c, d) {
        ...
        rl().set("nextId", d + 1, 86400, !0);
        rl().set("requests", e, 86400, !0);
        return d
    }

    function tl(a) {
        var b = rl().get("requests", !0) || {};
        delete b[a];
        rl().set("requests", b, 86400, !0)
    }
        ...
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(W()) - d.requestTime)) {
                    var e = d.authState,
                        f = pl(ol(!1));
                    mb(e, f) && (e = d.request, "requestTimeMs" in e && (e.requestTimeMs = Math.round(W())), vl(a, d.method, e, {}));
                    delete b[c]
                }
            }
            rl().set("requests", b, 86400, !0)
    ...
    function wl(a) {
        ...
        this.ka = !1;
        var b;
        this.lb = null != (b = a.lb) ? b : 100;
        var c;
        this.kb = null != (c = a.kb) ? c : 1;
        var d;
        this.ib = null != (d = a.ib) ? d : 2592E6;
        var e;
        this.hb = null != (e = a.hb) ? e : 12E4;
        var f;
        this.jb = null != (f = a.jb) ? f : 5E3;
        var g;
        this.A = null != (g = a.A) ? g : void 0;
        this.Aa = !!a.Aa;
        var h;
        this.za = null != (h = a.za) ? h : .1;
        var k;
        ...
        this.Qa = a.Qa;
        this.Pa = a.Pa;
        xl(this) && (!this.C || this.C("networkless_logging")) && yl(this)
    }

    function yl(a) {
        xl(a) && !a.ka && (a.i = !0, a.Aa && Math.random() <= a.za && a.F.qb(a.A), zl(a), a.H.K() && a.pa(), a.H.aa(a.Qa, a.pa.bind(a)), a.H.aa(a.Pa, a.Ua.bind(a)))
    }
    n = wl.prototype;
    ...
    n.sendThenWrite = function(a, b, c) {
        ...
        if (xl(this) && this.i) {
            ...
            if (this.H.K() || this.C && this.C("nwl_aggressive_send_then_write") && !e.skipRetry) {
                if (!e.skipRetry) {
                    var f = b.onError ? b.onError : function() {};
                    b.onError = function(g, h) {
                        return y(function(k) {
                            if (1 == k.i) return x(k, d.F.set(e, d.A).catch(function(l) {
                                Bl(d, l)
                            }), 2);
                            f(g, h);
                            k.i = 0
        ...
        } else this.R(a, b, this.C && this.C("nwl_skip_retry") && c)
    };
    n.sendAndWrite = function(a, b) {
        ...
        if (xl(this) && this.i) {
            ...
            d.options.onSuccess = function(g, h) {
                void 0 !== d.id ? c.F.ea(d.id, c.A) : e = !0;
                c.H.ba && c.C && c.C("vss_network_hint") && c.H.ba(!0);
                f(g, h)
            };
    ...
    n.pa = function() {
        var a = this;
        if (!xl(this)) throw nj("throttleSend");
        this.j || (this.j = this.L.S(function() {
            var b;
            return y(function(c) {
                if (1 == c.i) return x(c, a.F.Ya("NEW", a.A), 2);
                if (3 != c.i) return b = c.j, b ? x(c, Al(a, b), 3) : (a.Ua(), c.return());
                a.j && (a.j = 0, a.pa());
                c.i = 0
            })
        }, this.lb))
    ...
    function Al(a, b) {
        ...
        return y(function(e) {
            switch (e.i) {
                case 1:
                    if (!xl(a)) throw c = nj("immediateSend"), c;
                    if (void 0 === b.id) {
                        e.B(2);
                        break
                    }
                    return x(e, a.F.Ab(b.id, a.A), 3);
                case 3:
                    (d = e.j) ? b = d: a.ga(Error("The request cannot be found in the database."));
                case 2:
                    if (Cl(a, b, a.ib)) {
                        e.B(4);
                        break
                    }
                    a.ga(Error("Networkless Logging: Stored logs request expired age limit"));
                    if (void 0 === b.id) {
                        e.B(5);
                        break
                    }
                    return x(e, a.F.ea(b.id, a.A), 5);
                case 5:
                    return e.return();
                case 4:
                    b.skipRetry || (b = Dl(a, b));
                    if (!b) {
                        e.B(0);
                        break
                    }
    ...
    function Dl(a, b) {
        if (!xl(a)) throw nj("updateRequestHandlers");
        ...
        b.options.onError = function(e, f) {
            ...
            return y(function(l) {
                switch (l.i) {
                    case 1:
                        g = El(f);
                        if (!(a.C && a.C("nwl_consider_error_code") && g || a.C && !a.C("nwl_consider_error_code") && a.potentialEsfErrorCounter <= a.Da)) {
                            l.B(2);
                            break
                        }
                        if (!a.H.Fa) {
                    ...
                    case 3:
                        ...
                        return x(l, a.F.Ra(b.id, a.A, !1), 6);
                    case 6:
                        return l.return();
                    case 2:
                        ...
                        return b.sendCount < a.kb ? x(l, a.F.Ra(b.id, a.A), 12) : x(l, a.F.ea(b.id, a.A), 8);
                    case 12:
                        a.L.S(function() {
                            a.H.K() && a.pa()
                        }, a.jb);
        ...
        b.options.onSuccess = function(e, f) {
            var g;
            return y(function(h) {
                if (1 == h.i) return void 0 === (null == (g = b) ? void 0 : g.id) ? h.B(2) : x(h, a.F.ea(b.id, a.A), 2);
                a.H.ba && a.C && a.C("vss_network_hint") && a.H.ba(!0);
                d(e, f);
                h.i = 0
            })
        };
    ...
    function zl(a) {
        if (!xl(a)) throw nj("retryQueuedRequests");
        a.F.Ya("QUEUED", a.A).then(function(b) {
            b && !Cl(a, b, a.hb) ? a.L.S(function() {
                return y(function(c) {
                    if (1 == c.i) return void 0 === b.id ? c.B(2) : x(c, a.F.Ra(b.id, a.A), 2);
                    zl(a);
                    c.i = 0
                })
            }) : a.H.K() && a.pa()
    ...
    function Bl(a, b) {
        a.mb && !a.H.K() ? a.mb(b) : a.handleError(b)
    }
    ...
    function Hl() {
        if (Gl) return Gl();
        var a = {};
        Gl = dl("LogsDatabaseV2", {
            ma: (a.LogsRequestsStore = {
                Ja: 2
            }, a),
            Sa: !1,
            upgrade: function(b, c, d) {
                c(2) && Bj(b, "LogsRequestsStore", {
                    keyPath: "id",
                    autoIncrement: !0
                });
                c(3);
    ...
    function Ll(a, b) {
        ...
        return y(function(l) {
            ...
            if (3 != l.i) return d = l.j, e = P("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = [a, e, 0], g = [a, e, W()], h = IDBKeyRange.bound(f, g), k = void 0, x(l, Aj(d, ["LogsRequestsStore"], {
                    mode: "readwrite",
                    J: !0
                }, function(m) {
                    return Ak(m.objectStore("LogsRequestsStore").index("newRequestV2"), {
                        query: h,
                        direction: "prev"
                    }, function(p) {
                        p.V() && (k = p.V(), "NEW" === a && (k.status = "QUEUED", p.update(k)))
                    })
                }),
                3);
            c.Fb = W();
    ...
    function Ml(a, b) {
        var c;
        return y(function(d) {
            if (1 == d.i) return x(d, Il(b), 2);
            c = d.j;
            return d.return(Aj(c, ["LogsRequestsStore"], {
                mode: "readwrite",
                J: !0
            }, function(e) {
    ...
    function Nl(a, b, c) {
        ...
        var d;
        return y(function(e) {
            if (1 == e.i) return x(e, Il(b), 2);
            d = e.j;
            return e.return(Aj(d, ["LogsRequestsStore"], {
                mode: "readwrite",
                J: !0
            }, function(f) {
    ...
    function Pl(a) {
        var b, c;
        return y(function(d) {
            if (1 == d.i) return x(d, Il(a), 2);
            b = d.j;
            c = W() - 2592E6;
            return x(d, Aj(b, ["LogsRequestsStore"], {
                mode: "readwrite",
                J: !0
            }, function(e) {
                return xk(e.objectStore("LogsRequestsStore"), {}, function(f) {
                    if (f.V().timestamp <= c) return f.delete().then(function() {
                        return f.continue()
                    })
                })
            }), 0)
    ...
    var Rl = {},
        Sl = dl("ServiceWorkerLogsDatabase", {
            ma: (Rl.SWHealthLog = {
                Ja: 1
            }, Rl),
            Sa: !0,
            upgrade: function(a, b) {
                b(1) && Bj(a, "SWHealthLog", {
                    keyPath: "id",
                    autoIncrement: !0
    ...
    function Ul(a) {
        var b, c;
        y(function(d) {
            if (1 == d.i) return x(d, Tl(a), 2);
            b = d.j;
            c = W() - 2592E6;
            return x(d, Aj(b, ["SWHealthLog"], {
                mode: "readwrite",
                J: !0
            }, function(e) {
                return xk(e.objectStore("SWHealthLog"), {}, function(f) {
                    if (f.V().timestamp <= c) return f.delete().then(function() {
                        return f.continue()
                    })
                })
    ...
    function $l() {
        if (!Zl.i) {
            var a = C("yt.networkRequestMonitor.instance") || new Zl;
            B("yt.networkRequestMonitor.instance", a);
            Zl.i = a
        }
        return Zl.i
    }
    Zl.prototype.requestComplete = function(a, b) {
        b && (this.j = !0);
        a = this.removeParams(a);
        this.i.get(a) || this.i.set(a, b)
    };
    Zl.prototype.isEndpointCFR = function(a) {
        a = this.removeParams(a);
        return (a = this.i.get(a)) ? !1 : !1 === a && this.j ? !0 : null
    };
    Zl.prototype.removeParams = function(a) {
        return a.split("?")[0]
    };
    Zl.prototype.removeParams = Zl.prototype.removeParams;
    Zl.prototype.isEndpointCFR = Zl.prototype.isEndpointCFR;
    Zl.prototype.requestComplete = Zl.prototype.requestComplete;
    Zl.getInstance = $l;
    var am;

    function bm() {
        am || (am = new Vi("yt.offline"));
        return am
    }

    function cm(a) {
        if (R("offline_error_handling")) {
            var b = bm().get("errors", !0) || {};
            b[a.message] = {
                name: a.name,
                stack: a.stack
            };
            a.level && (b[a.message].level = a.level);
            bm().set("errors", b, 2592E3, !0)
        }
    };
    ...
    function X() {
        ...
        this.j.aa("networkstatus-online", function() {
            if (a.m && R("offline_error_handling")) {
                var b = bm().get("errors", !0);
                if (b) {
                    for (var c in b)
                        if (b[c]) {
                            var d = new Ri(c, "sent via offline_errors");
                            d.name = b[c].name;
                            d.stack = b[c].stack;
                            d.level = b[c].level;
                            Qh(d)
                        }
                    bm().set("errors", {}, 2592E3, !0)
                }
            }
        })
    }
    ...
    n.Fa = function(a) {
        a = Oe(this.j, a);
        a.then(function(b) {
            R("use_cfr_monitor") && $l().requestComplete("generate_204", b)
        });
        return a
    };
    X.prototype.sendNetworkCheckRequest = X.prototype.Fa;
    X.prototype.listen = X.prototype.aa;
    X.prototype.enableErrorFlushing = X.prototype.sb;
    X.prototype.getWindowStatus = X.prototype.vb;
    X.prototype.networkStatusHint = X.prototype.ba;
    X.prototype.isNetworkAvailable = X.prototype.K;
    X.getInstance = dm;
    ...
    function em(a) {
        ...
        this.j = this.v = 0;
        this.m = dm();
        var c = C("yt.networkStatusManager.instance.listen").bind(this.m);
        c && (a.Ea ? (this.Ea = a.Ea, c("networkstatus-online", function() {
            fm(b, "publicytnetworkstatus-online")
        }), c("networkstatus-offline", function() {
            fm(b, "publicytnetworkstatus-offline")
    ...
    em.prototype.ba = function(a) {
        var b = C("yt.networkStatusManager.instance.networkStatusHint").bind(this.m);
        b && b(a)
    };
    em.prototype.Fa = function(a) {
        var b = this,
            c;
        return y(function(d) {
            c = C("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.m);
            return R("skip_network_check_if_cfr") && $l().isEndpointCFR("generate_204") ? d.return(new Promise(function(e) {
                var f;
                b.ba((null == (f = window.navigator) ? void 0 : f.onLine) || !0);
                e(b.K())
    ...
    function fm(a, b) {
        a.Ea ? a.j ? (Re.da(a.v), a.v = Re.S(function() {
            a.o !== b && (Le(a, b), a.o = b, a.j = W())
        }, a.Ea - (W() - a.j))) : (Le(a, b), a.o = b, a.j = W()) : Le(a, b)
    };
    var gm;
    ...
    function hm() {
        ...
        a.call(wl, this, {
            ...
            mb: cm,
            L: Qi(),
            Qa: "publicytnetworkstatus-online",
            Pa: "publicytnetworkstatus-offline",
            Aa: !0,
            za: .1,
            Da: mi("potential_esf_error_limit", 10),
            C: R,
            ka: !(Si() && "www.youtube-nocookie.com" !== Ub(document.location.toString()))
        });
        this.l = new ng;
        R("networkless_immediately_drop_all_requests") && Ql();
        al("LogsDatabaseV2")
    }
    v(hm, wl);
    ...
    function jm() {
        ...
        a || (a = new hm, B("yt.networklessRequestController.instance", a), R("networkless_logging") && Tk().then(function(b) {
            a.A = b;
            yl(a);
            a.l.resolve();
            a.Aa && Math.random() <= a.za && a.A && Ul(a.A);
            R("networkless_immediately_drop_sw_health_store") && km(a)
        }));
        return a
    }
    hm.prototype.writeThenSend = function(a, b) {
        b || (b = {});
        Si() || (this.i = !1);
        wl.prototype.writeThenSend.call(this, a, b)
    };
    hm.prototype.sendThenWrite = function(a, b, c) {
        b || (b = {});
        Si() || (this.i = !1);
        wl.prototype.sendThenWrite.call(this, a, b, c)
    };
    hm.prototype.sendAndWrite = function(a, b) {
        b || (b = {});
        Si() || (this.i = !1);
        wl.prototype.sendAndWrite.call(this, a, b)
    };
    hm.prototype.awaitInitialization = function() {
    ...
    function km(a) {
        var b;
        y(function(c) {
            if (!a.A) throw b = nj("clearSWHealthLogsDb"), b;
            return c.return(Vl(a.A).catch(function(d) {
                a.handleError(d)
            }))
        })
    }
    ...
    function im(a, b, c) {
        R("use_cfr_monitor") && lm(a, b);
        if (R("use_request_time_ms_header")) b.headers && (b.headers["X-Goog-Request-Time"] = JSON.stringify(Math.round(W())));
        else {
            var d;
            if (null == (d = b.postParams) ? 0 : d.requestTimeMs) b.postParams.requestTimeMs = Math.round(W())
        }
        if (c && 0 === Object.keys(b).length) {
            var e = void 0 === e ? "" : e;
            var f = void 0 === f ? !1 : f;
            if (a)
                if (e) Ai(a, void 0, "POST", e);
                else if (P("USE_NET_AJAX_FOR_PING_TRANSPORT", !1)) Ai(a, void 0, "GET", "", void 0, void 0, f);
            else {
                b: {
                    try {
                        var g = new Za({
    ...
    function lm(a, b) {
        ...
        b.onError = function(e, f) {
            $l().requestComplete(a, !1);
            c(e, f)
        };
        var d = b.onSuccess ? b.onSuccess : function() {};
        b.onSuccess = function(e, f) {
            $l().requestComplete(a, !0);
            d(e, f)
        }
    };
    var mm = A.ytNetworklessLoggingInitializationOptions || {
        isNwlInitialized: !1
    };
    B("ytNetworklessLoggingInitializationOptions", mm);

    function nm(a) {
        var b = this;
        this.config_ = null;
        a ? this.config_ = a : fl() && (this.config_ = gl());
        Mi(function() {
            ul(b)
        }, 5E3)
    }
    nm.prototype.isReady = function() {
        !this.config_ && fl() && (this.config_ = gl());
        return !!this.config_
    };
    ...
    function vl(a, b, c, d) {
        function e(w) {
            w = void 0 === w ? !1 : w;
            var z;
            if (d.retry && "www.youtube-nocookie.com" != h && (w || R("skip_ls_gel_retry") || "application/json" !== g.headers["Content-Type"] || (z = sl(b, c, l, k)), z)) {
                var G = g.onSuccess,
                    K = g.onFetchSuccess;
            ...
            try {
                w && d.retry && !d.fb.bypassNetworkless ? (g.method = "POST", d.fb.writeThenSend ? jm().writeThenSend(q, g) : jm().sendAndWrite(q, g)) : R("web_all_payloads_via_jspb") ? xi(q, g) : (g.method = "POST", g.postParams || (g.postParams = {}), xi(q, g))
            } catch (M) {
                if ("InvalidAccessError" == M.name) z && (tl(z), z = 0), Rh(Error("An extension is blocking network request."));
                else throw M;
            }
            z && Mi(function() {
                ul(a)
            }, 5E3)
        }!P("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && Rh(new Ri("Missing VISITOR_DATA when sending innertube request.", b, c, d));
        if (!a.isReady()) {
            var f = new Ri("innertube xhrclient not ready", b, c, d);
            Qh(f);
            throw f;
        }
        var g = {
        ...
        C("ytNetworklessLoggingInitializationOptions") &&
            mm.isNwlInitialized ? Sk().then(function(w) {
                e(w)
            }) : e(!1)
    };
    var om = window.ytcsi && window.ytcsi.now ? window.ytcsi.now : window.performance && window.performance.timing && window.performance.now && window.performance.timing.navigationStart ? function() {
    ...
    function pm(a) {
        ...
        this.m = 0;
        this.Ga = $h(window, "mousemove", Va(this.Ha, this));
        this.Ia = bi(Va(this.Z, this), 25)
    }
    D(pm, ke);
    pm.prototype.Ha = function(a) {
        void 0 === a.i && Vh(a);
        var b = a.i;
        void 0 === a.j && Vh(a);
        this.i = new Hd(b, a.j)
    ...
    pm.prototype.Z = function() {
        if (this.i) {
            ...
            if (0 != this.o) {
                ...
                this.j[this.m] = .5 < Math.abs((d - this.v) / this.v) ? 1 : 0;
    ...
    function rm() {
        var a = {},
            b = void 0 === a.Bb ? !1 : a.Bb;
        a = void 0 === a.tb ? !0 : a.tb;
        if (null == C("_lact", window)) {
            var c = parseInt(P("LACT"), 10);
            c = isFinite(c) ? Date.now() - Math.max(c, 0) : -1;
            B("_lact", c, window);
            B("_fact", c, window); - 1 == c && sm();
            $h(document, "keydown", sm);
            $h(document, "keyup", sm);
            $h(document, "mousedown", sm);
            $h(document, "mouseup", sm);
            b ? $h(window, "touchmove", function() {
                tm("touchmove", 200)
            }, {
                passive: !0
            ...
            $h(document, "touchstart", sm, {
                passive: !0
            });
            $h(document, "touchend", sm, {
                passive: !0
            })
        }
    }
    ...
    var vm = A.ytPubsubPubsubInstance || new N,
    ...
    N.prototype.publish = N.prototype.ha;
    N.prototype.clear = N.prototype.clear;
    B("ytPubsubPubsubInstance", vm);
    B("ytPubsubPubsubTopicToKeys", xm);
    B("ytPubsubPubsubIsSynchronous", ym);
    B("ytPubsubPubsubSubscribedKeys", wm);

    function zm() {
        this.store = {}
    }
    zm.prototype.storePayload = function(a, b) {
        a = Am(a);
        this.store[a] ? this.store[a].push(b) : this.store[a] = [b];
        return a
    };
    zm.prototype.extractMatchingEntries = function(a) {
        a = Bm(this, a);
        for (var b = [], c = 0; c < a.length; c++) b.push.apply(b, ia(this.store[a[c]])), delete this.store[a[c]];
        return b
    };
    zm.prototype.getSequenceCount = function(a) {
        a = Bm(this, a);
    ...
    function Bm(a, b) {
        a = Object.keys(a.store) || [];
        if (1 >= a.length && Am(b) === a[0]) return a;
        for (var c = [], d = 0; d < a.length; d++) {
            var e = a[d].split("/");
            if (Cm(b.auth, e[0])) {
                var f = b.isJspb;
                Cm(void 0 === f ? "undefined" : f ? "true" : "false", e[1]) && Cm(b.cttAuthInfo, e[2]) && c.push(a[d])
            }
        }
        return c
    }
    ...
    zm.prototype.getSequenceCount = zm.prototype.getSequenceCount;
    zm.prototype.extractMatchingEntries = zm.prototype.extractMatchingEntries;
    zm.prototype.storePayload = zm.prototype.storePayload;
    ...
    var Dm = mi("initial_gel_batch_timeout", 2E3),
        Em = Math.pow(2, 16) - 1,
        Fm = void 0;
    ...
    B("ytLoggingTransportGELQueue_", Lm);
    var Mm = A.ytLoggingTransportGELProtoQueue_ || new Map;
    B("ytLoggingTransportGELProtoQueue_", Mm);
    var Nm = A.ytLoggingTransportTokensToCttTargetIds_ || {};
    B("ytLoggingTransportTokensToCttTargetIds_", Nm);
    var Om = A.ytLoggingTransportTokensToJspbCttTargetIds_ || {};
    B("ytLoggingTransportTokensToJspbCttTargetIds_", Om);
    var Pm = {};

    function Qm() {
        var a = C("yt.logging.ims");
        a || (a = new zm, B("yt.logging.ims", a));
        return a
    }

    function Rm(a, b) {
        R("web_all_payloads_via_jspb") && Rh(new Ri("transport.log called for JSON in JSPB only experiment"));
        if ("log_event" === a.endpoint) {
            Sm(a);
            var c = Tm(a);
            if (R("use_new_in_memory_storage")) {
                Pm[c] = !0;
                var d = {
                    cttAuthInfo: c,
                    isJspb: !1
                };
                Qm().storePayload(d, a.payload);
                Um(b, [], c, !1, d)
            } else d = Lm.get(c) || [], Lm.set(c, d), d.push(a.payload), Um(b, d, c)
        }
    }
    ...
    function Vm(a, b) {
        if ("log_event" === a.endpoint) {
            ...
            if (R("use_new_in_memory_storage")) {
                ...
                Qm().storePayload(d, a.payload.toJSON());
                Um(b, [], c, !0, d)
            } else d = Mm.get(c) || [], Mm.set(c, d), a = a.payload.toJSON(), d.push(a), Um(b, d, c, !0)
        }
    }
    ...
    function Um(a, b, c, d, e) {
        d = void 0 === d ? !1 : d;
        a && (Fm = new a);
        a = mi("tvhtml5_logging_max_batch") || mi("web_logging_max_batch") || 100;
        var f = W(),
            g = d ? Im.l : Hm.l;
        b = b.length;
        e && (b = Qm().getSequenceCount(e));
        b >= a ? R("background_thread_flush_logs_due_to_batch_limit") ? Jm || (Jm = Wm(function() {
            Xm({
                writeThenSend: !0
            }, R("flush_only_full_queue") ? c : void 0, d);
            Jm = void 0
        }, 0)) : Xm({
            writeThenSend: !0
        }, R("flush_only_full_queue") ? c : void 0, d) : 10 <= f - g && (Ym(d), d ? Im.l = f : Hm.l = f)
    }

    function Zm(a, b) {
        R("web_all_payloads_via_jspb") && Rh(new Ri("transport.logIsolatedGelPayload called in JSPB only experiment"));
        if ("log_event" === a.endpoint) {
            Sm(a);
            var c = Tm(a),
                d = new Map;
            d.set(c, [a.payload]);
            b && (Fm = new b);
            return new og(function(e, f) {
                Fm && Fm.isReady() ? $m(d, Fm, e, f, {
                    bypassNetworkless: !0
                }, !0) : e()
            })
        }
    ...
    function an(a, b) {
        if ("log_event" === a.endpoint) {
            ...
            b && (Fm = new b);
            return new og(function(e) {
                Fm && Fm.isReady() ? bn(d, Fm, e, {
                    bypassNetworkless: !0
                }, !0) : e()
            })
        }
    ...
    function Tm(a, b) {
        ...
        if (a.ja) c = "visitorOnlyApprovedKey";
            ...
            if (void 0 === b ? 0 : b) {
                ...
                Om[b] = d
            } else b = a.cttAuthInfo, c = {}, b.videoId ? c.videoId = b.videoId : b.playlistId && (c.playlistId = b.playlistId), Nm[a.cttAuthInfo.token] = c;
    ...
    function Xm(a, b, c) {
        a = void 0 === a ? {} : a;
        c = void 0 === c ? !1 : c;
        !c && R("web_all_payloads_via_jspb") && Rh(new Ri("transport.flushLogs called for JSON in JSPB only experiment"));
        new og(function(d, e) {
            c ? (cn(Im.j), cn(Im.i), Im.i = 0) : (cn(Hm.j), cn(Hm.i), Hm.i = 0);
            if (Fm && Fm.isReady())
                if (R("use_new_in_memory_storage")) {
                    var f = a,
                        g = c,
                    ...
                    var k = new Map,
                        l = new Map;
                    if (void 0 !== b) g ? (e = Qm().extractMatchingEntries({
                        isJspb: g,
                        cttAuthInfo: b
                    }), k.set(b, e), bn(k, h, d, f)) : (k = Qm().extractMatchingEntries({
                        isJspb: g,
                        cttAuthInfo: b
                    }), l.set(b, k), $m(l, h, d, e, f));
                    else if (g) {
                        e = u(Object.keys(Pm));
                        for (g = e.next(); !g.done; g = e.next()) l = g.value, g = Qm().extractMatchingEntries({
                            isJspb: !0,
                            cttAuthInfo: l
                        }), 0 < g.length && k.set(l, g), delete Pm[l];
                        bn(k, h, d, f)
                    } else {
                        k = u(Object.keys(Pm));
                        for (g = k.next(); !g.done; g = k.next()) {
                            g = g.value;
                            var m = Qm().extractMatchingEntries({
                                isJspb: !1,
                                cttAuthInfo: g
                            });
                ...
                } else f = a, k = c, h = Fm, f = void 0 === f ? {} : f, k = void 0 === k ? !1 : k, void 0 !== b ? k ? (e = new Map, k = Mm.get(b) || [], e.set(b,
                    k), bn(e, h, d, f), Mm.delete(b)) : (k = new Map, l = Lm.get(b) || [], k.set(b, l), $m(k, h, d, e, f), Lm.delete(b)) : k ? (bn(Mm, h, d, f), Mm.clear()) : ($m(Lm, h, d, e, f), Lm.clear());
            else Ym(c), d()
        })
    }
    ...
    function Ym(a) {
        a = void 0 === a ? !1 : a;
        if (R("web_gel_timeout_cap") && (!a && !Hm.i || a && !Im.i)) {
            var b = Wm(function() {
                Xm({
                    writeThenSend: !0
                }, void 0, a)
        ...
        cn(a ? Im.j : Hm.j);
        b = P("LOGGING_BATCH_TIMEOUT", mi("web_gel_debounce_ms", 1E4));
        R("shorten_initial_gel_batch_timeout") && Km && (b = Dm);
        b = Wm(function() {
            Xm({
                writeThenSend: !0
            }, void 0, a)
    ...
    function $m(a, b, c, d, e, f) {
        ...
        for (var l = a.next(); !l.done; k = {
            ...
            m = m.next().value;
            k.Y = nb({
                context: hl(b.config_ || gl())
            });
            if (!Oa(m) && !R("throw_err_when_logevent_malformed_killswitch")) {
                d();
                break
            }
            k.Y.events = m;
            ...
            k.ta = function(p) {
                return function() {
                    p.sa++;
                    if (e.bypassNetworkless && 1 === p.sa) try {
                        vl(b, "log_event", p.Y, gn({
                            writeThenSend: !0
                        }, p.ia, p.va, p.ta, f)), Km = !1
                    } catch (t) {
                        Qh(t), d()
                    }
                    h--;
            ...
            try {
                vl(b, "log_event", k.Y, gn(e, k.ia, k.va, k.ta, f)), Km = !1
            } catch (p) {
                Qh(p), d()
            }
        }
    ...
    function bn(a, b, c, d, e) {
        ...
        for (var k = h.next(); !k.done; k = h.next()) {
            var l = u(k.value).next().value,
                m = a.get(l);
            k = new Eh;
            var p = nl(b.config_ || gl());
            J(k, ih, 1, p);
            m = m ? hn(m) : [];
            m = u(m);
            for (p = m.next(); !p.done; p = m.next()) rd(k, 3, zh, p.value);
            (m = Om[l]) && jn(k, l, m);
            delete Om[l];
    ...
    function gn(a, b, c, d, e) {
        ...
        ln() && (a.headers["X-Goog-Request-Time"] = JSON.stringify(Math.round(W())));
        return a
    }

    function en(a, b, c) {
        ln() || (a.requestTimeMs = String(b));
        R("unsplit_gel_payloads_in_logs") && (a.unsplitGelPayloadsInLogs = !0);
        !c && (b = P("EVENT_ID")) && (c = mn(), a.serializedClientEventId = {
            serializedEventId: b,
    ...
    function mn() {
        var a = P("BATCH_CLIENT_COUNTER") || 0;
        a || (a = Math.floor(Math.random() * Em / 2));
        a++;
        a > Em && (a = 1);
        Kh("BATCH_CLIENT_COUNTER", a);
        return a
    }
    ...
    function hn(a) {
        for (var b = [], c = 0; c < a.length; c++) try {
            ...
            Qh(new Ri("Transport failed to deserialize " + String(a[c])))
        }
        return b
    }
    ...
    function Wm(a, b) {
        return R("transport_use_scheduler") ? Mi(a, b) : ai(a, b)
    }

    function cn(a) {
        R("transport_use_scheduler") ? Re.da(a) : window.clearTimeout(a)
    };
    var nn = A.ytLoggingGelSequenceIdObj_ || {};
    B("ytLoggingGelSequenceIdObj_", nn);
    ...
    function on(a, b, c, d) {
        ...
        e[a] = b;
        R("enable_unknown_lact_fix_on_html5") && rm();
        a = um();
        e.context = {
            lastActivityMs: String(d.timestamp || !isFinite(a) ? -1 : a)
        };
        R("log_sequence_info_on_gel_web") && d.oa && (a = e.context, b = d.oa, b = {
            index: pn(b),
            groupKey: b
        }, a.sequence = b, d.ub && delete nn[d.oa]);
        (d.Db ? Zm : Rm)({
            endpoint: "log_event",
            payload: e,
    ...
    var rn = A.ytLoggingGelSequenceIdObj_ || {};
    ...
    function sn(a) {
        ...
        b = void 0 === b ? {} : b;
        var c = !1;
        P("ytLoggingEventsDefaultDisabled", !1) && (c = !0);
        c = c ? null : nm;
        b = void 0 === b ? {} : b;
        var d = Math.round(b.timestamp || W());
        I(a, 1, d < Number.MAX_SAFE_INTEGER ? d : 0);
        var e = um();
        d = new yh;
        I(d, 1, b.timestamp || !isFinite(e) ? -1 : e);
        if (R("log_sequence_info_on_gel_web") && b.oa) {
            e = b.oa;
            var f = pn(e),
                g = new xh;
            I(g, 2, f);
    ...
    function tn(a, b) {
        var c = void 0 === c ? {} : c;
        if (R("migrate_events_to_ts")) {
            c = void 0 === c ? {} : c;
            var d = nm;
            P("ytLoggingEventsDefaultDisabled", !1) && nm === nm && (d = null);
            R("web_all_payloads_via_jspb") && Rh(new Ri("Logs should be translated to JSPB but are sent as JSON instead", a));
            on(a, b, d, c)
        } else d = nm, P("ytLoggingEventsDefaultDisabled", !1) && nm == nm && (d = null), on(a, b, d, c)
    };
    var un = [{
        Na: function(a) {
    ...
    function zn() {
        if (!yn) {
            ...
            a.W.length = 0;
            a.U.length = 0;
            wn.W && a.W.push.apply(a.W, wn.W);
            wn.U && a.U.push.apply(a.U, wn.U)
        }
        return yn
    };
    var An = new N;
    ...
    function Dn(a, b, c, d) {
        if (a)
            if (Array.isArray(a)) {
                var e = d;
                for (d = 0; d < a.length && !(a[d] && (e += En(d, a[d], b, c), 500 < e)); d++);
                d = e
            ...
            for (e in a) {
                if (a[e]) {
                    ...
                    var g = b;
                    var h = c;
                    g = "string" !== typeof f || "clickTrackingParams" !== e && "trackingParams" !== e ? 0 : (f = Bn(atob(f.replace(/-/g, "+").replace(/_/g, "/")))) ? En(e + ".ve", f, g, h) : 0;
                    d += g;
                    d += En(e, a[e], b, c);
                    if (500 < d) break
                }
            } else c[b] = Fn(a), d += c[b].length;
        else c[b] = Fn(a), d += c[b].length;
        return d
    }
    ...
    function Mn() {
        for (var a = u(Ln), b = a.next(); !b.done; b = a.next()) {
            var c = Kb();
    ...
    function Nn() {
        var a;
        return y(function(b) {
            return (a = lf()) ? b.return(a.then(function(c) {
                c = wd(c);
    ...
    function Pn(a) {
        return On[a] || (On[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
    ...
    function Tn() {
        for (var a = u(Rn), b = a.next(); !b.done; b = a.next()) b = b.value, b()
    }

    function Un(a, b) {
        var c;
        "yt:" === a.tagName.toLowerCase().substr(0, 3) ? c = a.getAttribute(b) : c = a ? a.dataset ? a.dataset[Pn(b)] : a.getAttribute("data-" + b) : null;
        return c
    }

    function Vn(a) {
        Fg.ha.apply(Fg, arguments)
    };
    ...
    function Yn(a, b, c) {
        Zn || (Zn = {}, $h(window, "message", function(d) {
            a: {
                if (d.origin === Xn(a, "host")) {
                    try {
                    ...
                    if (d = Zn[e.id]) d.v = !0, d.v && (E(d.o, d.sendMessage, d), d.o.length = 0), d.Ta(e)
                }
                e = void 0
            }
            return e
    ...
    n.destroy = function() {
        this.i && this.i.id && (Qn[this.i.id] = null);
        var a = this.m;
    ...
    function fo(a, b, c) {
        ...
        a.v ? a.sendMessage(b) : a.o.push(b)
    }
    ...
    function go(a, b) {
        ...
        c.setAttribute("title", "YouTube " + Xn(a.j, "title"));
        (b = Xn(a.j, "width")) && c.setAttribute("width", b.toString());
        (b = Xn(a.j, "height")) && c.setAttribute("height",
            b.toString());
        var g = a.Wa();
        ...
        var h = "" + Xn(a.j, "host") + ("/embed/" + Xn(a.j, "videoId")) + "?" + Xb(g);
        $n.yt_embedsEnableUaChProbe ? Nn().then(function(k) {
            var l = new URL(h),
            ...
            k = Wd(l.href).toString();
            Gd(c, Xd(k));
            return k
        }) : $n.yt_embedsEnableIframeSrcWithIntent ? Gd(c, Xd(h)) : c.src = h;
        return c
    }
    n.gb = function() {
    ...
    n.setup = function(a, b) {
        ...
        if (a = "string" === typeof a ? c.getElementById(a) : a)
            if (c = "iframe" === a.tagName.toLowerCase(), b.host || (b.host = c ? Vb(a.src) : "https://www.youtube.com"), this.j = new Wn(b), c || (b = go(this, a), this.u = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.i = a, this.i.id || (this.i.id = "widget" + Qa(this.i)), Qn[this.i.id] = this, window.postMessage) {
                this.m = new N;
                ho(this);
                b = Xn(this.j, "events");
                for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]);
                for (var e in Sn) Sn.hasOwnProperty(e) &&
                    eo(this, e)
            }
    };

    function co(a, b) {
        a.I[b] || (a.I[b] = !0, fo(a, "addEventListener", [b]))
    }
    n.sendMessage = function(a) {
        a.id = this.id;
        a.channel = "widget";
        var b = JSON.stringify(a),
            c = [Vb(this.i.src || "").replace("http:", "https:")];
        if (this.i.contentWindow)
            for (var d = 0; d < c.length; d++) try {
                this.i.contentWindow.postMessage(b, c[d])
            } catch (Qb) {
                if (Qb.name && "SyntaxError" === Qb.name) {
                    if (!(Qb.message && 0 < Qb.message.indexOf("target origin ''"))) {
                        var e = void 0,
                            f = Qb;
                        e = void 0 === e ? {} : e;
                        e.name = P("INNERTUBE_CONTEXT_CLIENT_NAME", 1);
                        e.version = P("INNERTUBE_CONTEXT_CLIENT_VERSION");
                        var g = e || {},
                            h = "WARNING";
                        h = void 0 === h ? "ERROR" :
                            h;
                        if (f) {
                            ...
                            if (!(5 <= Hn)) {
                                var m = void 0,
                                    ...
                                    q = g,
                                    w = Ad(t),
                                    z = w.message || "Unknown Error",
                                    G = w.name || "UnknownError",
                                    K = w.stack || t.j || "Not available";
                                if (K.startsWith(G + ": " + z)) {
                                    var M = K.split("\n");
                                    M.shift();
                                    K = M.join("\n")
                                ...
                                if (t.hasOwnProperty("args") && t.args && t.args.length)
                                    for (var ta = 0; ta < t.args.length && !(ya = Dn(t.args[ta], "params." + ta, q, ya), 500 <= ya); ta++);
                                ...
                                if (Kn.length)
                                    for (var Y = 0; Y < Kn.length && !(ya = Dn(Kn[Y], "params.context." + Y, q, ya), 500 <= ya); Y++);
                                ...
                                var S = {
                                    ...
                                    Ej = Number(t.columnNumber);
                                isNaN(Ej) || (S.lineNumber = S.lineNumber + ":" + Ej);
                                if ("IGNORED" === t.level) m = 0;
                                else a: {
                                    for (var Fj = zn(), Gj = u(Fj.W), Lf = Gj.next(); !Lf.done; Lf = Gj.next()) {
                                        var Hj = Lf.value;
                                        if (S.message && S.message.match(Hj.dc)) {
                                            m = Hj.weight;
                                            break a
                                        }
                                    }
                                    for (var Ij = u(Fj.U), Mf = Ij.next(); !Mf.done; Mf = Ij.next()) {
                                        var Jj = Mf.value;
                                        if (Jj.pb(S)) {
                                            m = Jj.weight;
                                            break a
                                ...
                                S.sampleWeight = m;
                                for (var Kj = u(un), Nf = Kj.next(); !Nf.done; Nf = Kj.next()) {
                                    var Of = Nf.value;
                                    if (Of.Ca[S.name])
                                        for (var Lj = u(Of.Ca[S.name]), Pf = Lj.next(); !Pf.done; Pf = Lj.next()) {
                                            var Mj = Pf.value,
                                                Od = S.message.match(Mj.regexp);
                                            if (Od) {
                                                S.params["params.error.original"] = Od[0];
                                                for (var Qf = Mj.groups, Nj = {}, Rb = 0; Rb < Qf.length; Rb++) Nj[Qf[Rb]] = Od[Rb + 1], S.params["params.error." + Qf[Rb]] = Od[Rb + 1];
                                                S.message = Of.Na(Nj);
                                                break
                                            }
                                        }
                                ...
                                S.params || (S.params = {});
                                var Oj = zn();
                                S.params["params.errorServiceSignature"] = "msg=" + Oj.W.length + "&cb=" + Oj.U.length;
                                ...
                                if (0 !== va.sampleWeight && !Gn.has(va.message)) {
                                    if ("ERROR" === h) {
                                        An.ha("handleError",
                                            va);
                                        if (R("record_app_crashed_web") && 0 === Jn && 1 === va.sampleWeight)
                                            if (Jn++, R("errors_via_jspb")) {
                                                var Rf = new wh;
                                                I(Rf, 1, 1);
                                                ...
                                                R("report_client_error_with_app_crash_ks") || (Uj.systemHealth = {
                                                    crashData: {
                                                        clientError: {
                                                            logMessage: {
                                                                message: va.message
                                        ...
                                        In++
                                    } else "WARNING" === h && An.ha("handleWarning", va);
                                    if (R("kevlar_gel_error_routing")) a: {
                                        ...
                                        if (R("errors_via_jspb")) {
                                            if (Mn()) Tf = void 0;
                                                ...
                                                var Sb = new oh;
                                                I(Sb, 1, Q.stack);
                                                Q.fileName && I(Sb, 4, Q.fileName);
                                                var Ka = Q.lineNumber && Q.lineNumber.split ? Q.lineNumber.split(":") : [];
                                                0 !== Ka.length && (1 !== Ka.length || isNaN(Number(Ka[0])) ? 2 !== Ka.length || isNaN(Number(Ka[0])) || isNaN(Number(Ka[1])) || (I(Sb, 2, Number(Ka[0])), I(Sb, 3, Number(Ka[1]))) : I(Sb, 2, Number(Ka[0])));
                                                var rb =
                                                    new rh;
                                                I(rb, 1, Q.message);
                                                I(rb, 3, Q.name);
                                                I(rb, 6, Q.sampleWeight);
                                                "ERROR" === Ic ? I(rb, 2, 2) : "WARNING" === Ic ? I(rb, 2, 1) : I(rb, 2, 0);
                                                var Uf = new ph;
                                                I(Uf, 1, !0);
                                                pd(Uf, oh, 3, qh, Sb);
                                                var sb = new lh;
                                                I(sb, 3, window.location.href);
                                                for (var Vj = P("FEXP_EXPERIMENTS", []), Vf = 0; Vf < Vj.length; Vf++) {
                                                    var Wj = sb,
                                                        oo = Vj[Vf];
                                                    $c(Wj);
                                                    jd(Wj, 5, 2, !1).push(oo)
                                                ...
                                                var Wf = Lh();
                                                if (!Mh() && Wf)
                                                    for (var Xj = u(Object.keys(Wf)), tb = Xj.next(); !tb.done; tb = Xj.next()) {
                                                        var Yj = tb.value,
                                                            Xf = new nh;
                                                        I(Xf, 1, Yj);
                                                        Xf.setValue(String(Wf[Yj]));
                                                        rd(sb, 4, nh, Xf)
                                                    }
                                                var Yf = Q.params;
                                                if (Yf) {
                                                    var Zj = u(Object.keys(Yf));
                                                    for (tb = Zj.next(); !tb.done; tb = Zj.next()) {
                                                        var ak = tb.value,
                                                            Zf = new nh;
                                                        I(Zf, 1, "client." + ak);
                                                        Zf.setValue(String(Yf[ak]));
                                                        rd(sb, 4, nh, Zf)
                                                    }
                                                }
                                                var bk = P("SERVER_NAME"),
                                                    ck = P("SERVER_VERSION");
                                                if (bk && ck) {
                                                    var $f = new nh;
                                                    I($f, 1, "server.name");
                                            ...
                                            if (Mn()) Sf =
                                                ...
                                                var La = Q.lineNumber && Q.lineNumber.split ? Q.lineNumber.split(":") : [];
                                                0 !== La.length && (1 !== La.length || isNaN(Number(La[0])) ? 2 !== La.length || isNaN(Number(La[0])) || isNaN(Number(La[1])) || (Jc.lineNumber = Number(La[0]), Jc.columnNumber = Number(La[1])) : Jc.lineNumber = Number(La[0]));
                                                var bg = {
                                                ...
                                                "ERROR" === Ic ? bg.level = "ERROR_LEVEL_ERROR" : "WARNING" ===
                                                    Ic && (bg.level = "ERROR_LEVEL_WARNNING");
                                                var po = {
                                                        isObfuscated: !0,
                                                        browserStackInfo: Jc
                                                    },
                                                ...
                                                P("FEXP_EXPERIMENTS") && (Tb.experimentIds = P("FEXP_EXPERIMENTS"));
                                                var cg = Lh();
                                                if (!Mh() && cg)
                                                    for (var fk = u(Object.keys(cg)), ub = fk.next(); !ub.done; ub = fk.next()) {
                                                        var gk = ub.value;
                                                        Tb.kvPairs.push({
                                                            key: gk,
                                                            value: String(cg[gk])
                                                ...
                                                var dg = Q.params;
                                                if (dg) {
                                                    var hk = u(Object.keys(dg));
                                                    for (ub = hk.next(); !ub.done; ub = hk.next()) {
                                                        var ik = ub.value;
                                                        Tb.kvPairs.push({
                                                            key: "client." + ik,
                                                            value: String(dg[ik])
                                        ...
                                        if ("ERROR" === Ic || R("errors_flush_gel_always_killswitch")) b: if (R("migrate_events_to_ts")) c: {
                                            if (R("web_fp_via_jspb") && (qn(!0), !R("web_fp_via_jspb_and_json"))) break c;qn()
                                        }
                                        else {
                                            if (R("web_fp_via_jspb") && (qn(!0), !R("web_fp_via_jspb_and_json"))) break b;
                                            qn()
                                        }
                                    }
                                    if (!R("suppress_error_204_logging")) {
                                        ...
                                        if (Ya.postParams) {
                                            ...
                                            for (var mk = u(Object.keys(Kc)), eg = mk.next(); !eg.done; eg = mk.next()) {
                                                var nk = eg.value;
                                                Ya.postParams["client." + nk] = Kc[nk]
                                            }
                                            var fg = Lh();
                                            if (fg)
                                                for (var ok = u(Object.keys(fg)),
                                                        gg = ok.next(); !gg.done; gg = ok.next()) {
                                                    var pk = gg.value;
                                                    Ya.postParams[pk] = fg[pk]
                                                }
                                            var qk = P("SERVER_NAME"),
                                                rk = P("SERVER_VERSION");
                                            qk && rk && (Ya.postParams["server.name"] = qk, Ya.postParams["server.version"] = rk)
                                        }
                                        xi(P("ECATCHER_REPORT_HOST", "") + "/error_204", Ya)
                                    }
                                    try {
                                        Gn.add(va.message)
                                    } catch (uo) {}
    ...
    n.Ta = function(a) {
        ...
        switch (b) {
            case "apiInfoDelivery":
                if (Pa(a))
                    for (var c in a) a.hasOwnProperty(c) && (this.O[c] = a[c]);
                break;
            case "infoDelivery":
                lo(this, a);
                break;
            case "initialDelivery":
                Pa(a) && (window.clearInterval(this.l), this.playerInfo = {}, this.O = {}, mo(this, a.apiInterface), lo(this, a));
                break;
            default:
                bo(this, b, a)
        }
    ...
    function lo(a, b) {
        if (Pa(b)) {
            ...
            a.playerInfo.hasOwnProperty("videoData") && (b = a.playerInfo.videoData, b.hasOwnProperty("title") && b.title ? (b = b.title, b !== a.videoTitle && (a.videoTitle = b, a.i.setAttribute("title", b))) : (a.videoTitle = "", a.i.setAttribute("title", "YouTube " + Xn(a.j, "title"))))
        }
    }
    ...
    n.getVideoEmbedCode = function() {
        var a = Xn(this.j, "host") + ("/embed/" + Xn(this.j, "videoId")),
            b = Number(Xn(this.j, "width")),
            c = Number(Xn(this.j, "height"));
    ...
    n.getOptions = function(a) {
        return this.O.namespaces ? a ? this.O[a] ? this.O[a].options || [] : [] : this.O.namespaces || [] : []
    };
    n.getOption = function(a, b) {
        if (this.O.namespaces && a && b && this.O[a]) return this.O[a][b]
    };
    ...
    B("YT.subscribe", function(a, b, c) {
        Fg.subscribe(a, b, c);
        Sn[a] = !0;
        for (var d in Qn) Qn.hasOwnProperty(d) && eo(Qn[d], a)
    });
    B("YT.unsubscribe", function(a, b, c) {
        Eg(a, b, c)
    });
    B("YT.Player", ko);
    ao.prototype.destroy = ao.prototype.destroy;
    ao.prototype.setSize = ao.prototype.setSize;
    ao.prototype.getIframe = ao.prototype.getIframe;
    ao.prototype.addEventListener = ao.prototype.addEventListener;
    ko.prototype.getVideoEmbedCode = ko.prototype.getVideoEmbedCode;
    ko.prototype.getOptions = ko.prototype.getOptions;
    ko.prototype.getOption = ko.prototype.getOption;
    Rn.push(function(a) {
        var b = a;
        b || (b = document);
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || Tn();
    var ro = A.onYTReady;
    ro && ro();
    var so = A.onYouTubeIframeAPIReady;
    so && so();
    var to = A.onYouTubePlayerAPIReady;
    to && to();
}).call(this);